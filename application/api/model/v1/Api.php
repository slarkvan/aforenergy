...
class Api extends Base
{
    ...
    private function getViewInfo($aid, $users = [])
    {
        ...
        $detail = Db::name('archives')
            ->alias('a')
            ->field('a.aid,a.typeid,a.channel,a.title,a.litpic,a.author,a.click,a.arcrank,a.seo_title,a.seo_keywords,a.seo_description,a.users_price,a.users_discount_type,a.users_free,a.old_price,
            a.sales_num,a.virtual_sales,a.sales_all,a.stock_show,a.stock_count,a.prom_type,a.arc_level_id,a.downcount,a.add_time,a.attrlist_id,b.typename,a.restric_type')
