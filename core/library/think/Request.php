...
class Request
{
    ...
    public function rootDomain($domain = '', $tq_suffix = false)
    {
        ...
        if (!$root || !empty($domain)) {
            ...
            $domain_postfix_cn_array = ["ac", "ah", "bj", "cn", "com", "co", "cq", "fj", "edu", "gd", "gs", "gov", "goho", "gx", "gz", "ha", "hb", "he", "hi", "hl", "hk", "hn", "jl", "js", "jx", "ln", "lt", "me", "mo", "net", "nm", "nx", "org", "plc", "qh", "sc", "sd", "sh", "sn", "sx", "tj", "tw", "xj", "xz", "yn", "zj"];
            $array_domain = explode(".", $host);
            $array_num = count($array_domain) - 1;
            if (in_array($array_domain[$array_num], ['cn','tw','hk','nz','au','uk','co'])) {
