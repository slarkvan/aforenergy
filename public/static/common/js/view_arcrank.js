            ...
            if (ajax.readyState == 4 && ajax.status == 200) {
                ...
                if (1 == res.code) {
                    if (res.data.status_value == 0){ // 所有人免费
                        ...
                        videoPeriodObj.innerHTML = '<div class="video-free-now button button-big bg-yellow text-center radius-rounded text-middle" style="cursor: pointer;" onclick="'+res.data.button_url+'">VIP</div>';
                    }
