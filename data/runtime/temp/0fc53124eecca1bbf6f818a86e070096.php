<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:46:"./application/admin/template/download/edit.htm";i:1692667952;s:80:"/www/wwwroot/testweb.aforenergy.com/application/admin/template/public/layout.htm";i:1692667952;s:83:"/www/wwwroot/testweb.aforenergy.com/application/admin/template/public/theme_css.htm";i:1680508822;s:98:"/www/wwwroot/testweb.aforenergy.com/application/admin/template/archives/get_field_addonextitem.htm";i:1680508822;s:80:"/www/wwwroot/testweb.aforenergy.com/application/admin/template/public/footer.htm";i:1680508822;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form class="form-horizontal" id="post_form" action="<?php echo url('Download/edit'); ?>" method="post">
        ...
        <div class="ncap-form-default tab_div_1">
            ...
            <div class="<?php if(empty($channelRow['data']['is_download_pay'])): ?> none <?php endif; ?>">
                ...
                <dl class="row <?php if(in_array($field['restric_type'], [0]) || ($field['restric_type'] == 2 && $field['no_vip_pay'] == 0)): ?> none <?php endif; ?>" id="dl_users_price">
                    <dt class="tit">
            ...
            <dl class="row" style="z-index: 2;">
                ...
                <dd class="opt">
                    <div class="layui-upload">
                            ...
                            <table class="layui-table">
                                ...
                                <tbody id="demoList">
                                    <?php if(is_array($downfile_list) || $downfile_list instanceof \think\Collection || $downfile_list instanceof \think\Paginator): $i = 0; $__LIST__ = $downfile_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(empty($vo['is_remote']) || (($vo['is_remote'] instanceof \think\Collection || $vo['is_remote'] instanceof \think\Paginator ) && $vo['is_remote']->isEmpty())): ?>
                                            <tr>
                                                <td><a href="<?php echo $vo['file_url']; ?>" target="_blank"><?php echo (isset($vo['file_name']) && ($vo['file_name'] !== '')?$vo['file_name']:''); ?></a></td>
                                                <td  class="th_server_name" <?php if($servername_use != '1'): ?> style="display: none;" <?php endif; ?>>
                                                    <input type="text" name="fileupload[server_name][]" value="<?php echo $vo['server_name']; ?>" id="servername_local_<?php echo $key+1; ?>" onclick="searchServername(this);" autocomplete="off">
                                                    <div class="help-hot-list" style="display: none;" id="search_keywords_list_servername_local_<?php echo $key+1; ?>"></div>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <input type="hidden" name="fileupload[file_url][]" value="<?php echo (isset($vo['file_url']) && ($vo['file_url'] !== '')?$vo['file_url']:''); ?>">
                                                    <input type="hidden" name="fileupload[file_mime][]" value="<?php echo (isset($vo['file_mime']) && ($vo['file_mime'] !== '')?$vo['file_mime']:''); ?>">
                                                    <input type="hidden" name="fileupload[file_name][]" value="<?php echo (isset($vo['file_name']) && ($vo['file_name'] !== '')?$vo['file_name']:''); ?>">
                                                    <input type="hidden" name="fileupload[file_ext][]" value="<?php echo (isset($vo['file_ext']) && ($vo['file_ext'] !== '')?$vo['file_ext']:''); ?>">
                                                    <input type="hidden" name="fileupload[file_size][]" value="<?php echo (isset($vo['file_size']) && ($vo['file_size'] !== '')?$vo['file_size']:''); ?>">
                                                    <input type="hidden" name="fileupload[uhash][]" value="<?php echo (isset($vo['uhash']) && ($vo['uhash'] !== '')?$vo['uhash']:''); ?>">
                                                    <input type="hidden" name="fileupload[md5file][]" value="<?php echo (isset($vo['md5file']) && ($vo['md5file'] !== '')?$vo['md5file']:''); ?>">
                                                </td>
                                            </tr>
                                ...
                                <div class="template_div">
                                    ...
                                    <?php if(is_array($attr_field) || $attr_field instanceof \think\Collection || $attr_field instanceof \think\Paginator): $i = 0; $__LIST__ = $attr_field;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                        <span class="ey_<?php echo $vo['field_name']; ?>" <?php if($vo['field_use'] != '1'): ?> style="display: none;" <?php endif; ?>>
                                            ...
                                            <div class="help-hot-list remote-hot-list" style="display: none;" id="search_keywords_list_<?php echo $vo['field_name']; ?>_remote_1">
                                ...
                                <?php else: if(is_array($downfile_list) || $downfile_list instanceof \think\Collection || $downfile_list instanceof \think\Paginator): $i = 0; $__LIST__ = $downfile_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['is_remote'] == '1'): ?>
                                            <div class="template_div">
                                                ...
                                                <?php if(is_array($attr_field) || $attr_field instanceof \think\Collection || $attr_field instanceof \think\Paginator): $i = 0; $__LIST__ = $attr_field;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$f_vo): $mod = ($i % 2 );++$i;?>
                                                    <span class="ey_<?php echo $f_vo['field_name']; ?>" <?php if($f_vo['field_use'] != '1'): ?> style="display: none;" <?php endif; ?>>
                                                        <span class="title_<?php echo $f_vo['field_name']; ?>"><?php echo $f_vo['field_title']; ?></span>：<input type="text" name="<?php echo $f_vo['field_name']; ?>[]" id="<?php echo $f_vo['field_name']; ?>_remote_<?php echo $num-1; ?>" style="width: 7%;" value="<?php echo $vo[$f_vo['field_name']]; ?>" <?php if($f_vo['field_name']=='server_name'): ?> onclick="searchServername(this);" autocomplete="off" <?php endif; ?>>
                                                        <?php if($f_vo['field_name']=='server_name'): ?>
                                                        <div class="help-hot-list remote-hot-list" style="display: none;" id="search_keywords_list_<?php echo $f_vo['field_name']; ?>_remote_<?php echo $num-1; ?>">
                        ...
                        <input type="hidden" name="fileName" id="fileName" value="<?php echo (isset($file_name) && ($file_name !== '')?$file_name:''); ?>" style="width: 100%;">
            ...
            if (ext>-1) {
                ...
                if (1 == servername_use){
                    $("#demoList").append(
                        ...
                        '<td>'+ file.name +'</td>'+
                        '<td class="th_server_name"><input type="text" name="fileupload[server_name][]" value="七牛云服务器" id="severname_qiniuyun_'+i+'" onclick="searchServername(this);" autocomplete="off">'+
                        '<div class="help-hot-list" style="display: none;" id="search_keywords_list_severname_qiniuyun_'+i+'"></div>'+
                        '</td>'+
                    ...
                    $("#demoList").append(
                        '<tr id="upload-'+ timestamp +'">'+
                        '<td>'+ file.name +'</td>'+
                        '<td class="th_server_name" style="display: none;"><input type="text" name="fileupload[server_name][]" value="七牛云服务器" id="severname_qiniuyun_'+i+'" onclick="searchServername(this);" autocomplete="off">'+
                        '<div class="help-hot-list" style="display: none;" id="search_keywords_list_severname_qiniuyun_'+i+'"></div>'+
                        '</td>'+
                        '<td>'+ (file.size/1014).toFixed(1) +' KB</td>'+
                        '<td>等待上传</td>'+
            ...
            if (ext>-1) {
                ...
                if (1 == servername_use) {
                    $("#demoList").append(
                        '<tr id="upload-' + timestamp + '">' +
                        '<td>' + file.name + '</td>' +
                        '<td class="th_server_name"><input type="text" name="fileupload[server_name][]" value="阿里云存储" id="severname_aliyun_' + i + '" onclick="searchServername(this);" onkeyup="searchServername(this);" autocomplete="off">' +
                        '<div class="help-hot-list" style="display: none;" id="search_keywords_list_severname_aliyun_' + i + '"></div>' +
                        '</td>' +
                        '<td>' + (file.size / 1014).toFixed(1) + ' KB</td>' +
                        '<td>等待上传</td>' +
                        '<td><button class="layui-btn layui-btn-xs layui-btn-danger demo-delete" style="line-height:unset;height: unset;" onclick="DeleteFile(this);">移除</button>' +
                    ...
                    $("#demoList").append(
                        '<tr id="upload-' + timestamp + '">' +
                        '<td>' + file.name + '</td>' +
                        '<td  class="th_server_name" style="display: none;"><input type="text" name="fileupload[server_name][]" value="阿里云存储" id="severname_aliyun_' + i + '" onclick="searchServername(this);" onkeyup="searchServername(this);" autocomplete="off">' +
                        '<div class="help-hot-list" style="display: none;" id="search_keywords_list_severname_aliyun_' + i + '"></div>' +
                        '</td>' +
                        '<td>' + (file.size / 1014).toFixed(1) + ' KB</td>' +
                        '<td>等待上传</td>' +
            ...
            success: function (res) {
                ...
                if(res.code == 1){
                    if (res.data.length > 0) {
                        ...
                        // console.log($('#search_keywords_list_'+sinput_id));return false;
