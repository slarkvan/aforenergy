<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:42:"./template/mobile/lists_single_contact.htm";i:1694417357;s:60:"/www/wwwroot/testweb.aforenergy.com/template/mobile/head.htm";i:1702175699;s:62:"/www/wwwroot/testweb.aforenergy.com/template/mobile/bottom.htm";i:1694417357;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
 <head> 
  <meta charset="utf-8" /> 
        ...
        <div class="ys_navph2_list">
          ...
          <div class="ys_navph2_lang_modal">
            ...
            <div class="he_main">
                ...
                <!-- <div class="he_funav">
                    <div class="he_conten1">
                        <div class="he_funavul">
                            <div class="he_funavli yxnav_active2">
                                <a href="/contact/contact-us">
                                    联系我们
                                </a>
                            </div>
                            <div class="he_funavli ">
                                <a href="/contact/contact-us?tp1">
                                    在线留言
                                </a>
                            </div>
                        </div>
                ...
                <div class="he_f1p2" style="padding-top:30px">
                    <div class="he_conten3">
                        <div class="he_f1p2bx">
                            <div class="he_f1p2ul clearfix">


                               <div class="he_f1p1nli fl wow g_fadeup1" data-num="0" style="width:24%;padding-top:40px;">
                                    <div class="he_f1p1nbn" style="padding: 34px 26px 45px 16px;">
                                        <div class="he_f1p1na1 clearfix">
                                            <div class="he_f1p1na1le fl">
                                                <p>
                                                    China
                                                </p>
                                            </div>
                                            <div class="he_f1p1na1ri fl">
                                                <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/china.jpeg" alt="f1g3.jpg">
                                            </div>
                                        </div>
                                        <div class="he_f1p1na2">
                                            <div class="he_f1p1na2li">
                                                <div class="he_f1p1na2lii">
                                                    <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/f1icon1.svg" alt="" class="he_img">
                                                    <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/f1icon4.svg" alt="" class="he_img1">
                                                </div>
                                                <div class="he_f1p1na2liz" >
                                                    <p>
                                                        Building 7, No.333 Wanfang Rd，Minhang District,
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="he_f1p1na2li" >
                                                <div class="he_f1p1na2lii" >
                                                    <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/f1icon2.svg" alt="" class="he_img">
                                                    <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/f1icon5.svg" alt="" class="he_img1">
                                                </div>
                                                <div class="he_f1p1na2liz">
                                                    <p>
                                                        +86-21-54326236
                                            ...
                                            <div class="he_f1p1na2li">
                                                <div class="he_f1p1na2lii">
                                                    <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/f1icon3.svg" alt="" class="he_img">
                                                    <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/f1icon6.svg" alt="" class="he_img1">
                                                </div>
                                                <div class="he_f1p1na2liz">
                                                    <p>
                                                        info@aforenergy.com
                                 ...
                                 <div class="he_f1p1nli fl wow g_fadeup1" data-num="0" style="width:24%;padding-top:40px;">
                                    <div class="he_f1p1nbn" style="padding: 34px 26px 45px 16px;">
                                        <div class="he_f1p1na1 clearfix">
                                            ...
                                            <div class="he_f1p1na1ri fl">
                                                <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/u.jpeg" alt="f1g3.jpg">
                                            </div>
                                        </div>
                                        <div class="he_f1p1na2">
                                            <div class="he_f1p1na2li">
                                                ...
                                                <div class="he_f1p1na2liz" >
                                                    <p>
                                                        Wetmore Road, Burton on Trent,Staffordshire DE 14 1LS, United Kingdom
                                                    </p>
                                                </div>
                                            </div>
                                           <!--  <div class="he_f1p1na2li" >
                                                <div class="he_f1p1na2lii" >
                                                    <img src="<?php echo $GLOBALS['skin']; ?>img/f1icon2.svg" alt="" class="he_img">
                                                    <img src="<?php echo $GLOBALS['skin']; ?>img/f1icon5.svg" alt="" class="he_img1">
                                                </div>
                                                <div class="he_f1p1na2liz">
                                                    <p>
                                                        +86-21-54326236
                                 ...
                                 <div class="he_f1p1nli fl wow g_fadeup1" data-num="0" style="width:24%;padding-top:40px;">
                                    <div class="he_f1p1nbn" style="padding: 34px 26px 45px 16px;">
                                        <div class="he_f1p1na1 clearfix">
                                            ...
                                            <div class="he_f1p1na1ri fl">
                                                <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/wukelan.jpg" alt="f1g3.jpg">
                                            </div>
                                        </div>
                                        <div class="he_f1p1na2">
                                            <div class="he_f1p1na2li">
                                                ...
                                                <div class="he_f1p1na2liz" >
                                                    <p>
                                                        03035 Kyiv, Ukraine 2 Generala Shapovala, off.306
                                                    </p>
                                                </div>
                                            </div>
                                           <!--  <div class="he_f1p1na2li" >
                                 ...
                                 <div class="he_f1p1nli fl wow g_fadeup1" data-num="0" style="width:24%;padding-top:40px;">
                                    <div class="he_f1p1nbn" style="padding: 34px 26px 45px 16px;">
                                        <div class="he_f1p1na1 clearfix">
                                            ...
                                            <div class="he_f1p1na1ri fl">
                                                <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/Netherlands.jpeg" alt="f1g3.jpg">
                                            </div>
                                        </div>
                                        <div class="he_f1p1na2">
                                            <div class="he_f1p1na2li">
                                                ...
                                                <div class="he_f1p1na2liz" >
                                                    <p>
                                                        Hazeldonk 6802 - 4836 LK Breda, Nederland
                                                    </p>
                                                </div>
                                            </div>
                                          <!--   <div class="he_f1p1na2li" >
                                ...
                                <div class="he_f1p1nli fl wow g_fadeup1" data-num="0" style="width:24%;padding-top:40px;">
                                    <div class="he_f1p1nbn" style="padding: 34px 26px 45px 16px;">
                                        <div class="he_f1p1na1 clearfix">
                                            ...
                                            <div class="he_f1p1na1ri fl">
                                                <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/f1g5.jpeg" alt="f1g3.jpg">
                                            </div>
                                        </div>
                                        <div class="he_f1p1na2">
                                            <div class="he_f1p1na2li">
                                                ...
                                                <div class="he_f1p1na2liz" >
                                                    <p>
                                                        Plot No. C 1/2/3/4,Gidc,Opp.Alpesh Roadways, Vithal Udyognagar, Anand, Gujarat – 388121, India.
                                                    </p>
                                                </div>
                                            </div>
                                          <!--   <div class="he_f1p1na2li" >
                                ...
                                <div class="he_f1p1nli fl wow g_fadeup1" data-num="0" style="width:24%;padding-top:40px;">
                                    <div class="he_f1p1nbn" style="padding: 34px 26px 45px 16px;">
                                        <div class="he_f1p1na1 clearfix">
                                            ...
                                            <div class="he_f1p1na1ri fl">
                                                <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/japan.jpeg" alt="f1g3.jpg">
                                            </div>
                                        </div>
                                        <div class="he_f1p1na2">
                                            <div class="he_f1p1na2li">
                                                ...
                                                <div class="he_f1p1na2liz" >
                                                    <p>
                                                       Fukuokaken,Okawashi Oazahonkimuro 306-5, Japan
                                                    </p>
                                                </div>
                                            </div>
                                          <!--   <div class="he_f1p1na2li" >
                                ...
                                <div class="he_f1p1nli fl wow g_fadeup1" data-num="0" style="width:24%;padding-top:40px;">
                                    <div class="he_f1p1nbn" style="padding: 34px 26px 45px 16px;">
                                        <div class="he_f1p1na1 clearfix">
                                            ...
                                            <div class="he_f1p1na1ri fl">
                                                <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/yisilanka.jpg" alt="f1g3.jpg">
                                            </div>
                                        </div>
                                        <div class="he_f1p1na2">
                                            <div class="he_f1p1na2li">
                                                ...
                                                <div class="he_f1p1na2liz" >
                                                    <p>
                                                       No.26A, Daham Mawatha Maharagama, Sri Lanka.
                                                    </p>
                                                </div>
                                            </div>
                                          <!--   <div class="he_f1p1na2li" >
                                  ...
                                  <div class="he_f1p1nli fl wow g_fadeup1" data-num="0" style="width:24%;padding-top:40px;">
                                    <div class="he_f1p1nbn" style="padding: 34px 26px 45px 16px;">
                                        <div class="he_f1p1na1 clearfix">
                                            ...
                                            <div class="he_f1p1na1ri fl">
                                                <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/Poland.jpeg" alt="f1g3.jpg">
                                            </div>
                                        </div>
                                        <div class="he_f1p1na2">
                                            <div class="he_f1p1na2li">
                                                ...
                                                <div class="he_f1p1na2liz" >
                                                    <p>
                                                      38-300 GorliceUl. Biecka 21Poland
                                                    </p>
                                                </div>
                                            </div>
                                          <!--   <div class="he_f1p1na2li" >
                                ...
                                <div class="he_f1p1nli fl wow g_fadeup1" data-num="0" style="width:24%;padding-top:40px;">
                                    <div class="he_f1p1nbn" style="padding: 34px 26px 45px 16px;">
                                        <div class="he_f1p1na1 clearfix">
                                            ...
                                            <div class="he_f1p1na1ri fl">
                                                <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/f1g4.jpeg" alt="f1g3.jpg">
                                            </div>
                                        </div>
                                        <div class="he_f1p1na2">
                                            <div class="he_f1p1na2li">
                                                ...
                                                <div class="he_f1p1na2liz" >
                                                    <p>
                                                     15 Terra Cotta Drive, Blackburn VIC 3130
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="he_f1p1na2li" >
                                            ...
                                            <!-- <div class="he_f1p1na2li">
                                                <div class="he_f1p1na2lii">
                                                    <img src="<?php echo $GLOBALS['skin']; ?>img/f1icon3.svg" alt="" class="he_img">
                                                    <img src="<?php echo $GLOBALS['skin']; ?>img/f1icon6.svg" alt="" class="he_img1">
                                                </div>
                                                <div class="he_f1p1na2liz">
                                                    <p>
                                                        wew@afore.com.pl
                ...
                <div class="he_f1p3">
                    <div class="he_conten3">
                        <div class="he_f1p3bx" style="background:url(<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/f1pic01.jpeg) center / cover no-repeat">
                            <div class="he_f1p3nk clearfix">
                                <div class="he_f1p3nl1">
                                    <p>
                                        Sunshine cooperation, honesty and win-win!
                                    </p>
                                </div>
                                <div class="he_f1p3nl2">
                                    <div class="he_f1p3nja">
                                        <p>
                                            After sales service center
                                        </p>
                                    </div>
                                    <div class="he_f1p3njl ">
                                        <a href="tel:400-998-1212">
                                            <div class="he_f1p3ngsle">
                                                <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/f1phon.svg" alt="">
                                            </div>
                                            <div class="he_f1p3ngsri">
                                                <p>
                                                    400-133-9885（China）
                                                </p>
                                            </div>
                                ...
                                <div class="he_f1p3code">
                                    <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/ewm.jpg" alt="shouhouerweima.jpg">
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="he_f1p4 he_d1bxli" data-num="1">
                    <div class="s_d2cont2 he_conten3">
                        <form id="form1" method="post">
                            <div class="s_d2c1tit font1 s_d2c2tit">
                                <h2>
                                    <span>
                                        Online 
                                    </span>
                            ...
                            <div class="s_d2c2main">
                                <div class="s_d2c2m1 clearfix s_d2c2m">
                                    <div class="s_d2c2input fl">
                                        <div class="s_d2c2inputbox">
                                            <input type="text" name="subject">
                                            <div class="s_d2c2inputwz p18">
                                                Theme
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="s_d2c2m2 clearfix s_d2c2m">
                                    <div class="s_d2c2input fl">
                                        <div class="s_d2c2inputbox">
                                    ...
                                    <!--<div class="s_d2c2inputwz p18">邮箱</div>-->
                                    <!--</div>-->
                                    <!--</div>-->
                                </div>
                               
                                <!--<div class="s_d2c2m4 clearfix s_d2c2m s_d2c2mn">-->
                                <!--<div class="s_d2c2input fl">-->
                                <!--<div class="s_d2c2inputbox">-->
                                <!--<input type="text" name="street">-->
                                <!--<div class="s_d2c2inputwz p18">街道</div>-->
                                <!--</div>-->
                                <!--</div>-->
                                <!--<div class="s_d2c2input fl">-->
                                <!--<div class="s_d2c2inputbox">-->
                                <!--<input type="text" name="city">-->
                                <!--<div class="s_d2c2inputwz p18">城市</div>-->
                                <!--</div>-->
                                <!--</div>-->
                                <!--<div class="s_d2c2input fl">-->
                                <!--<div class="s_d2c2inputbox">-->
                                <!--<input type="text" name="code">-->
                                <!--<div class="s_d2c2inputwz p18">邮政编码</div>-->
                                <!--</div>-->
                                <!--</div>-->
                                <!--</div>-->
                                <!--<div class="s_d2c2m5 clearfix s_d2c2m s_d2c2mn">-->
                                <!--<div class="s_d2c2input fl">-->
                                <!--<div class="s_d2c2inputbox">-->
                                <!--<input type="text" name="title">-->
                                <!--<div class="s_d2c2inputwz p18">标题</div>-->
                                <!--</div>-->
                                <!--</div>-->
                                <!--<div class="s_d2c2input fl">-->
                                <!--<div class="s_d2c2inputbox">-->
                                <!--<input type="text" name="fax">-->
                                <!--<div class="s_d2c2inputwz p18">传真</div>-->
                                <!--</div>-->
                                <!--</div>-->
                                <!--</div>-->
                                <!--<div class="s_d2c2m6 clearfix s_d2c2m s_d2c2mn">-->
                                <!--<div class="s_d2c2input fl">-->
                                <!--<div class="s_d2c2inputbox">-->
                                <!--<input type="text" name="info">-->
                                <!--<div class="s_d2c2inputwz p18">信息一</div>-->
                                <!--</div>-->
                                <!--</div>-->
                                <!--</div>-->
                                <!--<div class="s_d2c2m7 clearfix s_d2c2m s_d2c2mn">-->
                                <!--<div class="s_d2c2input fl">-->
                                <!--<div class="s_d2c2inputbox">-->
                                <!--<input type="text" name="infos">-->
                                <!--<div class="s_d2c2inputwz p18">信息二</div>-->
                                <!--</div>-->
                                <!--</div>-->
                                <!--</div>-->
                                <div class="s_d2c2m8 s_d2c2m ">
                                    <div class="s_d2c2input">
                                        <div class="s_d2c2inputbox">
                                            <div class="s_d2c2inputwz p18">
                                                Content
                                            </div>
                                ...
                                <input type="hidden" name="modelid" value="47">
                                <div class="s_d2c2m11" onclick="submitForm('form1')">
                                    <div class="s_d2c2tj p18">
                                        Submit
                                    </div>
                                </div>
                            </div>
    ...
    <script>
      console.log('%c','color:green')
        ...
        function submitForm(){
            ...
            $.post("index.php?c=message&a=add",{data},function(data,status){
                console.log(data,"=data")
            });
        }
        
            // 地图
$('.he_f1p1nli').click(function() {
    var indexco = $(this).data('num');
    $('.he_ghdot').eq(indexco).addClass('on').siblings().removeClass('on');
    var coord = $(this).find('.he_f1p1nbn').data('coord');
    var arr = coord.split("%")[0];
    var arrj = Math.floor(arr) - 50 + Math.floor(arr) + "%";
    var arr1 = coord.split("%")[1];
    var arr1j = Math.floor(arr1) - 50 + Math.floor(arr1) + "%";
    var hebing = arrj + arr1j;
    $('.he_ghigwb').css('transform-origin', hebing);
    // console.log(coord)
    $('.he_f1p1').addClass('on');
    $('.he_ghigwb').addClass('on');
})

$(".he_f1p1lul").on("beforeChange", function(a, b, c, nextIndex) {
    $('.he_f1p1nli[data-slick-index=' + nextIndex + ']').trigger("click");
});

//  坐标点点击

$('.he_ghdot').click(function() {
    var dotd = $(this).data("dotx");
    console.log(dotd)
    $(".he_f1p1lul").slick("slickGoTo", dotd);
})
...
$(".s_d2c2input textarea").on('input', function() {
    if (!($(this).val() == '')) {
        $(this).parents(".s_d2c2input").find(".s_d2c2inputwz").addClass('on');
    } else {
        $(this).parents(".s_d2c2input").find(".s_d2c2inputwz").removeClass('on');
...
$('.he_f1p1lul').slick({
    ...
    centerPadding: '200px',
    slidesToShow: 4,
    prevArrow: ".he_f1p1btle",
    nextArrow: ".he_f1p1btri",
    focusOnSelect: true,
    responsive: [{
        breakpoint: 1681,
        settings: {
...
$('.he_f1p1nli').click(function() {
    $('.he_f1p1map').addClass('he_xiox')
    var num = $(this).data("num");
    console.log(num)
    $('.he_f1p1mli').eq(num).fadeIn().siblings().hide();
    $('.he_f1p1mli').eq(num).addClass('on').siblings().removeClass('on');
    // $(".he_f1p1mwb img").attr("src", src);
    anime({
        targets: '.he_f1p1mli',
        opacity: ['0', '1'],
        easing: 'linear',
...
$(".he_f1p1lul").on("beforeChange", function(a, b, c, nextIndex) {
    $('.he_f1p1map').addClass('he_xiox')
    $('.he_f1p1mli').eq(nextIndex).fadeIn().siblings().hide();
    $('.he_f1p1mli').eq(nextIndex).addClass('on').siblings().removeClass('on');
});
