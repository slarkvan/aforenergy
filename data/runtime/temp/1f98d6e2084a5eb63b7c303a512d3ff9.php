<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:33:"./template/pc/view_warranty_a.htm";i:1704352479;s:56:"/www/wwwroot/testweb.aforenergy.com/template/pc/head.htm";i:1726294558;s:58:"/www/wwwroot/testweb.aforenergy.com/template/pc/bottom.htm";i:1721290442;}*/ ?>
<!--
 * @Author: ZhouQishun
 * @Date: 2023-12-26 06:33:29
 * @LastEditTime: 2024-01-04 15:14:39
 * @LastEditors: ZhouQishun
 * @Description: 1.0.0
 * @FilePath: \afceshixin.weibaoke.com.cn\template\pc\view_warranty_a.htm
 *
-->
<!DOCTYPE html>
<html lang="zh-CN">
...
<head>
    ...
    <?php  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/bootstrap.min-v3.3.5.css","","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/slick.css","","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/slick-theme.css","","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/animate.min.css","","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/base-v1.4.css","","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/jquery.mCustomScrollbar.min.css","","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/animate.min.css","","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/iconfont.css","","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/main.css","","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/media.css","","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/he_base.css","","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/swiper.min.css","","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/weui.min.css","","","",""); echo $__VALUE__; ?>
</head>
...
<style data-id="my">
    ...
    .weui-dialog__btn.weui-dialog__btn_error {
        color: #e50011;
    }

    .he_main .he_b1p4bjgk p {
        text-align: left;
    }
</style>
  ...
  <div class="ys_navph2_header">
                ...
                <div class="he_conten1">
                    <div class="he_bantnv">
                        <div class="he_bantti1">
                            <h1>
                                <p>
                                    <?php echo $eyou['field']['englist_name']; ?>
                                </p>
                            </h1>
                        </div>
                    </div>
    ...
    <div class="he_main">
        <div class="he_k5p1">
            ...
            <div class="he_conten1">
                <div class="he_k5p1bt clearfix">

                    <div class="he_k5p1ri fl">
                        <div class="he_k5p1ribn">
                            <div class="he_k5p1ex">
                                <div class="he_k5p1de clearfix">
                                    <div class="he_k5p1dele fl">
                                        <div class="he_k5p1din">
                                            <div class="s_b2_2c1search s_xljj">
                                                <input type="text" id="txtcode"
                                                    placeholder=" Please enter the serial number to check " name="keys"
                                                    value="<?php echo $eyou['field']['sn_code']; ?>">
                                                <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/b2_2icon1.png"
                                                    alt="" class="keywords">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="he_k5p1deri fr sao-box">
                                        <p>
                                            Search
                                        </p>
                                    </div>
                            ...
                            <div class="he_k5p1djg">
                                <div class="he_k5p1dte">
                                    <p>
                                        <span class="search">
                                        </span>
                                        Search Result
                                ...
                                <div class="he_k5p1dld">
                                    <div class="he_k5p1dldli clearfix">
                                        <div class="he_k5p1dsle fl">
                                            <p>
                                                SN
                                            </p>
                                        </div>
                                        <div class="he_k5p1dsri fl one">
                                            <p>
                                                <?php echo (isset($eyou['field']['sn_code']) && ($eyou['field']['sn_code'] !== '')?$eyou['field']['sn_code']:"No information!"); ?>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="he_k5p1dldli clearfix">
                                        ...
                                        <div class="he_k5p1dsri fl two">
                                            <p>
                                                <?php echo (isset($eyou['field']['model']) && ($eyou['field']['model'] !== '')?$eyou['field']['model']:"No information!"); ?>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="he_k5p1dldli clearfix">
                                        ...
                                        <div class="he_k5p1dsri fl three">
                                            <p>
                                                <?php echo (isset($eyou['field']['period']) && ($eyou['field']['period'] !== '')?$eyou['field']['period']:"No information!"); ?>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="he_k5p1dldli clearfix">
                                        <div class="he_k5p1dsle fl">
                                            <p>
                                                End of Warranty (MM-DD-YYYY)
                                            </p>
                                        </div>
                                        <div class="he_k5p1dsri fl three">
                                            <p>
                                                <?php echo (isset($eyou['field']['end_date']) && ($eyou['field']['end_date'] !== '')?$eyou['field']['end_date']:"No information!"); ?>
                                            </p>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="he_k5p3">
            <div class="he_k5p3ti">
                <div class="he_k5p2ti">
                    ...
                    <?php if(($eyou['field']['terms_filse'])): ?>
                    <a href="<?php echo $eyou['field']['terms_filse']; ?>" class="he_x40ft"
                        style="font-size: 16px;color: #e50011; cursor: pointer;display: block; text-align: center;"
                        target="_blank">Download</a>
                    <?php endif; ?>

                </div>
                <div class="he_b1p4bjgk wow g_fadeup1" style="
    position: relative;
    margin-top: 64px;
    padding: 0 80px;
    padding-bottom: 70px;">
                    ...
                    <?php if($eyou['field']['terms']): ?>
                    <div class=""><?php echo htmlspecialchars_decode($eyou['field']['terms']); ?></div>
                    <?php else: ?>
                    <div class=""><?php echo htmlspecialchars_decode($eyou['field']['total_terms']); ?></div>
                    <?php endif; ?>
                </div>
...
<?php  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/js/weui.min.js","","","",""); echo $__VALUE__; ?>

<script>
    $('.sao-box').on('click', function () {
        var $code = $("#txtcode");
        if (trim($code.val()).length < 4 || trim($code.val()).length > 20) {
            weui.alert("防伪码长度输入不正确!");
            $code.focus();
        }
        else {
            // var url = "<?php echo url('Track/show','code=c_code'); ?>";
            // url = url.replace("c_code", trim($code.val()));
            //url= url.replace("c_rand",Math.random());
            //console.log(url);
            // window.location = url;
    ...
    function getDate(keywords) {
        let myHeaders = new Headers();
        myHeaders.append("Content-Type", "application/json");
        let $code = $("#txtcode");

        let formdata = {
            channelid: "<?php echo $eyou['field']['channel']; ?>",
            typeid: "<?php echo $eyou['field']['typeid']; ?>",
            apiList: `ekey=1&page=1&pagesize=99&keywords=${keywords}`
        }
        ...
        fetch("<?php echo url('api/v1.Api/archivesList', '_ajax=1'); ?>", requestOptions)
            .then(response => response.json())
            .then(result => {
                loading.hide()
                if (result.code === 1 && result.data) {
                    if (result.data.apiList[1].total > 0 && result.data.apiList[1].data) {
                        let item = result.data.apiList[1].data[0]
                        let url = "<?php echo url('View/index','aid=item_aid'); ?>";
                        url = url.replace("item_aid", item.aid);
                        window.location = url
                    } else {
                        weui.alert("No information!", {
                            buttons: [
                                {
                                    label: "OK",
                                    type: "error",
