<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"./application/admin/template/index/index.htm";i:1694413847;s:83:"/www/wwwroot/testweb.aforenergy.com/application/admin/template/public/theme_css.htm";i:1680508822;s:81:"/www/wwwroot/testweb.aforenergy.com/application/admin/template/public/menubox.htm";i:1571728724;s:78:"/www/wwwroot/testweb.aforenergy.com/application/admin/template/public/left.htm";i:1692667952;}*/ ?>
<!doctype html>
<html>
<head>
...
<title><?php echo (isset($global['web_name']) && ($global['web_name'] !== '')?$global['web_name']:''); ?>-<?php if(!(empty($is_eyou_authortoken) || (($is_eyou_authortoken instanceof \think\Collection || $is_eyou_authortoken instanceof \think\Paginator ) && $is_eyou_authortoken->isEmpty()))): ?>网站管理系统<?php endif; ?><?php echo $version; ?></title>
            ...
            <!--   <em class="eyou_tool em_authortoken" data-expanded="close">
              ...
              <em class="eyou_tool em_diyminipro" data-expanded="close">
                ...
                <ul class="dropdown-menu" role="menu" aria-labelledby="shouquan">
                    ...
                    <li class="ey-tool-list text-center"><a class="liaojie" href="<?php if($vo['code'] == 'Diyminipro'): ?><?php echo url($vo['code'].'/page_edit'); else: ?><?php echo weapp_url($vo['code'].'/'.$vo['code'].'/page_edit'); endif; ?>" target="_blank" onclick="$('.em_diyminipro').toggleClass('open');"><?php echo $vo['name']; ?></a></li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                </ul>
               </em>
              <?php endif; ?>
