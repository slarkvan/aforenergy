<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:44:"./application/admin/template/article/add.htm";i:1692667952;s:80:"/www/wwwroot/testweb.aforenergy.com/application/admin/template/public/layout.htm";i:1692667952;s:83:"/www/wwwroot/testweb.aforenergy.com/application/admin/template/public/theme_css.htm";i:1680508822;s:98:"/www/wwwroot/testweb.aforenergy.com/application/admin/template/archives/get_field_addonextitem.htm";i:1680508822;s:80:"/www/wwwroot/testweb.aforenergy.com/application/admin/template/public/footer.htm";i:1680508822;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <div class="<?php if(empty($channelRow['data']['is_article_pay'])): ?> none <?php endif; ?>">
                ...
                <div class="none" id="div_free_html">
                    ...
                    <dl class="row none" id="dl_size">
                        ...
                        <dd class="opt">
                            <input type="text" name="size" value="1024" id="size" class="input-txt" maxlength="100" autocomplete="off" style="width: 100px !important;text-align: right;" onkeyup="this.value=this.value.replace(/[^\d\.]/g,'');" onpaste="this.value=this.value.replace(/[^\d\.]/g,'')">&nbsp;字节(1024字节=1KB)
                            <span class="err"></span>
                            <p class="notic"></p>
                        </dd>
                    </dl>
