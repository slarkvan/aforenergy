<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:33:"./template/pc/lists_article_q.htm";i:1704359471;s:56:"/www/wwwroot/testweb.aforenergy.com/template/pc/head.htm";i:1726294558;s:58:"/www/wwwroot/testweb.aforenergy.com/template/pc/bottom.htm";i:1721290442;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
...
<div class="he_index">
  ...
  <div class="he_main">
    <div class="s_content">
      ...
      <div class="s_d2content s_d3content">
        <!--面包屑-->
        <div class="he_bordkm">
          <div class="s_cont1360">
          ...
          <div class="s_d2cont1 s_cont1514">
            ...
            <!--<h2></h2>-->
            <!--</div>-->
            <div class="s_d3cont clearfix">
              <div class="s_d3contl fl">
                ...
                <div
                  class="s_d3contlnr wow g_fadeup1 <?php if($eyou['field']['typeid'] === $field['typeid']): ?> act <?php endif; ?>">
                  <a href="<?php echo $field['typeurl']; ?>">
                    <div class="s_d3conttw clearfix">
                      <div class="s_d3contwig">
                        <img src="<?php echo $field['icon']; ?>" alt="<?php echo $field['icon']; ?>" />
                      </div>
                      <div class="s_d3contwz font1 fr">
                        <h4><?php echo $field['typename']; ?></h4>
                      </div>
                    </div>
                  </a>
                </div>
              ...
              <div class="s_d3contr fr">
                <?php  $typeid = "";  if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $param = array(      "typeid"=> $typeid,      "notypeid"=> "",      "flag"=> "",      "noflag"=> "",      "channel"=> "",      "keyword"=> "",      "idlist"=> "",      "idrange"=> "", ); $tagList = new \think\template\taglib\eyou\TagList; $_result_tmp = $tagList->getList($param, 100, "", "", "desc", "on","off","");if(!empty($_result_tmp) && (is_array($_result_tmp) || $_result_tmp instanceof \think\Collection || $_result_tmp instanceof \think\Paginator)): $i = 0; $e = 1; $__LIST__ = $_result = $_result_tmp["list"]; $__PAGES__ = $_result_tmp["pages"];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $aid = $field["aid"];$users_id = $field["users_id"];$field["title"] = text_msubstr($field["title"], 0, 100, false);$field["seo_description"] = text_msubstr($field["seo_description"], 0, 160, true);$i= intval($key) + 1;$mod = ($i % 2 );  $aid = $field['aid']; $tagArcview = new \think\template\taglib\eyou\TagArcview; $_result = $tagArcview->getArcview($aid, "",""); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator):  $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: $fieldView = $__LIST__;$users_id = $fieldView["users_id"];?>
                    <div class=" yxedr_active font1 g_fadeup1" style="margin-top: 20px;">
                      <?php echo $fieldView['content']; ?>
                    </div>
                  <?php endif; else: echo htmlspecialchars_decode("");endif; unset($aid); unset($users_id); $fieldView = []; ?>
                    <!-- <div class=" yxedr_active font1 g_fadeup1" style="margin-top: 20px;">
...
<script>
  console.log('%c', 'color:green')
    ...
    <script>
      $(".s_d3contlnr").click(function () {
        var index = $(this).index();
        $(this).addClass("act");
        $(this).siblings().removeClass("act");
        $(".s_d3contrnr").eq(index).stop().fadeIn().siblings(".s_d3contrnr").stop().hide();
        $(".s_d3contrnr")[index].slick.refresh();
      })
    </script>
