<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:31:"./template/pc/lists_product.htm";i:1726017936;s:56:"/www/wwwroot/testweb.aforenergy.com/template/pc/head.htm";i:1726294558;s:58:"/www/wwwroot/testweb.aforenergy.com/template/pc/bottom.htm";i:1721290442;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8" />
                                            ...
                                            <div class="he_c03bti">
                                                <div class="he_c03btdt clearfix wow g_fadeup1">
                                                    <div class="he_c03btile fl">
                                                        <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/lanmutubiao/Residential-PV-Solutions.png">
                                                    </div>
                                                    <div class="he_c03btiri fl">
                                                        <h2 class="he_x40ft">Residential PV Solutions</h2>
                                                    </div>
                                                </div>
  ...
  'row' => '9',
                                        ...
                                        <div class="he_c03bcli he_d1bxli" id="2">
                                            <div class="he_c03bti">
                                                <div class="he_c03btdt clearfix wow g_fadeup1">
                                                    <div class="he_c03btile fl">
                                                        <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/lanmutubiao/Commercial-Utility-PV-Soulutions.png" alt="wuding.svg">
                                                    </div>
                                                    <div class="he_c03btiri fl">
                                                        <h2 class="he_x40ft"> Commercial & Utility PV Solutions</h2>
                                                    </div>
                                                </div>
                                                <div class="he_c03btkx wow g_fadeup1">
                                                    <p>If you need more product information, please contact customer service</p>
  ...
  'row' => '9',
                                        ...
                                        <div class="he_c03bcli he_d1bxli" id="3">
                                            <div class="he_c03bti">
                                                <div class="he_c03btdt clearfix wow g_fadeup1">
                                                    <div class="he_c03btile fl">
                                                        <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/lanmutubiao/Residential-Storage-Solutions.png" alt="dianli.svg">
                                                    </div>
                                                    <div class="he_c03btiri fl">
                                                        <h2 class="he_x40ft"> Residential Storage Solutions</h2>
                                                    </div>
                                                </div>
                                                <div class="he_c03btkx wow g_fadeup1">
                                                    <p>If you need more product information, please contact customer service</p>
  ...
  'row' => '9',
                                        ...
                                        <div class="he_c03bcli he_d1bxli" id="4">
                                            <div class="he_c03bti">
                                                <div class="he_c03btdt clearfix wow g_fadeup1">
                                                    <div class="he_c03btile fl">
                                                        <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/lanmutubiao/Commercial-Industrial-Storage-Solutions.png" alt="">
                                                    </div>
                                                    <div class="he_c03btiri fl">
                                                        <h2 class="he_x40ft"> Commercial & Industrial Storage Solutions</h2>
                                                    </div>
                                                </div>
                                                <div class="he_c03btkx wow g_fadeup1">
                                                    <p>If you need more product information, please contact customer service</p>
  ...
  'row' => '9',
                                        ...
                                        <div class="he_c03bcli he_d1bxli" id="5">
                                            <div class="he_c03bti">
                                                <div class="he_c03btdt clearfix wow g_fadeup1">
                                                    <div class="he_c03btile fl">
                                                        <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/lanmutubiao/Smart-Energy.png">
                                                    </div>
                                                    <div class="he_c03btiri fl">
                                                        <h2 class="he_x40ft">Smart Energy</h2>
                                                    </div>
                                                </div>
                                                <div class="he_c03btkx wow g_fadeup1">
                                                    <p>If you need more product information, please contact customer service</p>
  ...
  'row' => '9',
                                         ...
                                         <div class="he_c03bcli he_d1bxli" id="5">
                                            <div class="he_c03bti">
                                                <div class="he_c03btdt clearfix wow g_fadeup1">
                                                    <div class="he_c03btile fl">
                                                        <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/lanmutubiao/Accessories.png">
                                                    </div>
                                                    <div class="he_c03btiri fl">
                                            ...
                                            <div class="he_c03bxf">
                                                <div class="he_c03xul">
                                                    <?php  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = "94"; endif; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  if(isset($ui_row) && !empty($ui_row)) : $row = $ui_row; else: $row = 50; endif; $modelid = ""; $param = array(      "typeid"=> $typeid,      "notypeid"=> "",      "flag"=> "",      "noflag"=> "",      "channel"=> $modelid,      "joinaid"=> "",      "keyword"=> "",      "release"=> "off",      "idlist"=> "",      "idrange"=> "",      "aid"=> "", ); $tag = array (
  'loop' => '50',
  'typeid' => '94',
  'r' => 'eyou:artlist',
  'row' => '50',
