<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:23:"./template/pc/index.htm";i:1721810587;s:56:"/www/wwwroot/testweb.aforenergy.com/template/pc/head.htm";i:1726294558;s:58:"/www/wwwroot/testweb.aforenergy.com/template/pc/bottom.htm";i:1721290442;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8" />
    ...
    <?php  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/iframe.css","","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/bootstrap.min-v3.3.5.css","","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/slick.css","","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/slick-theme.css","","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/animate.min.css","","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/base-v1.4.css","","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/jquery.mCustomScrollbar.min.css","","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/animate.min.css","","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/css/iconfont.css","","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/main.css","","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/media.css","","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/he_base.css","","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/swiper.min.css","","","",""); echo $__VALUE__;  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/css/gr.css","","","",""); echo $__VALUE__; ?>
  </head>
...
<div class="he_index">
  ...
  <div class="ys_navph2_header">
    ...
    <div class="he_banbx">
      <div class="he_banul">
        ...
        <!--    <img src="<?php  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/img/banner1.jpg","","","",""); echo $__VALUE__; ?>" class="he_banph" alt="" />-->
           
        <!--    <video-->
        <!--      src="http://1251075830.vod2.myqcloud.com/8af421dfvodgzp1251075830/894e9da25576678021016298013/gslyGjMq5vsA.mp4"-->
        <!--      muted=""-->
        <!--    ></video>-->
        <!--  </div>-->
        ...
        <!--          <p>Leading supplier of green energy solutions</p>-->
        <!--        </div>-->
        <!--        <div class="he_bantti2">-->
        <!--          <p>-->
        <!--            Return the earth to a blue sky and become the world's most valuable green energy-->
        <!--            enterprise-->
        <!--          </p>-->
        <!--        </div>-->
        <!--      </div>-->
        ...
        <div class="he_banli">
          <a href="#">
            <div class="he_banig">
              <img src="<?php echo $field['litpic']; ?>" class="he_banpc" alt="PC-574.jpg" />
              <!--<img src="<?php echo $field['litpic']; ?>" class="he_banph" alt="" />-->
              <!-- 手机端 -->
            </div>
            <!-- banner文字 -->
            <div class="he_bante">
    ...
    <div class="he_main">
      ...
      <div class="jj">
        <div class="commen">
          <div class="bt aos-init aos-animate" data-aos="fade-up">
            <h1>Product</h1>
            <span></span>
          </div>
        </div>
        <div class="jja">
          <div
            class="jjb fl"
            style="background-image: url('<?php  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/img/shouyecp001.jpg","","","",""); echo $__VALUE__; ?>')"
          >
            <a href="#">
              <h5>01</h5>
              <h6>Residential PV Solutions</h6>
              <span></span>
              <!-- <p>aaaaaaaaaaaaaaa</p> -->
            </a>
          </div>
          ...
          <div
            class="jjb fl"
            style="background-image: url('<?php  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/img/shouyecp002.jpg","","","",""); echo $__VALUE__; ?>')"
          >
            <a href="#">
              <h5>02</h5>
              <h6>Commercial & Utility PV Solutions</h6>
              <span></span>
              <!-- <p>bbbbbbbbbbbbbbb</p> -->
            </a>
          </div>
          ...
          <div
            class="jjb fl"
            style="background-image: url('<?php  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/img/shouyecp003.jpg","","","",""); echo $__VALUE__; ?>')"
          >
            <a href="#">
              <h5>03</h5>
              <h6>Residential Storage Solutions</h6>
              <span></span>
          ...
          <div
            class="jjb fl"
            style="background-image: url('<?php  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/img/shouyecp004.jpg","","","",""); echo $__VALUE__; ?>')"
          >
            <a href="#">
              <h5>04</h5>
              <h6>Commercial & Industrial Storage Solutions</h6>
              <span></span>
              <!-- <p>ccccccccc</p> -->
            </a>
          </div>

          <!--    <div class="jjb fl" style="background-image: url('/upload/image/20220830/76220558f71fe1fd2164d43d8a2beb9a.jpg?raw=04.jpg');">
                    <a href="solutions/grohome-system">
                        <h5>05</h5>
                        <h6>Smart Energy</h6>
                        <span></span>
                        <p>ccccccccc</p>
        ...
        <div class="he_conten2">
          <div class="he_syp2ti">
            <div class="he_sytipu wow g_fadeup1">
              <h3>News and Exhibition</h3>
            </div>
          </div>
          <div class="he_syp2bx clearfix">
            <div class="he_syp2le fl wow g_fadeleft1">
              <div class="he_syp2len">
                <img src="<?php  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/img/syflo1.png","","","",""); echo $__VALUE__; ?>" alt="" class="he_img" />
  ...
  'row' => '4',
                    ...
                    <img src="<?php echo $field['litpic']; ?> " alt="<?php echo $field['title']; ?>" class="he_img1" />
                    <?php ++$e; $aid = 0; $users_id = 0; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>
                  </div>
                </div>
              </div>
  ...
  'r' => 'eyou:artlist',
  'row' => '4',
); $tagArclist = new \think\template\taglib\eyou\TagArclist; $_result = $tagArclist->getArclist($param, $row, "", "","desc","",$tag,"0","on","off","","");if(!empty($_result["list"]) && (is_array($_result["list"]) || $_result["list"] instanceof \think\Collection || $_result["list"] instanceof \think\Paginator)): $i = 0; $e = 1; $__LIST__ = is_array($_result["list"]) ? array_slice($_result["list"],0, $row, true) : $_result["list"]->slice(0, $row, true);  $__TAG__ = $_result["tag"];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $aid = $field["aid"];$users_id = $field["users_id"];$field["title"] = text_msubstr($field["title"], 0, 70, false);if($field["is_b"] == 1) : $field["title"] = "<strong>".$field["title"]."</strong>";endif;$field["seo_description"] = text_msubstr($field["seo_description"], 0, 160, true);$i= intval($key) + 1;$mod = ($i % 2 ); ?>
                <div class="he_syp2rli wow g_fadeup1">
                  <a href="<?php echo $field['arcurl']; ?>">
                    <div class="he_syp2rte">
                      <span class="he_syp1tim"><?php echo MyDate('Y-m-d',$field['add_time']); ?></span>
                      <p class="he_syp1tom"><?php echo $field['title']; ?></p>
                    </div>
                  </a>
                </div>
                <?php ++$e; $aid = 0; $users_id = 0; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>
          ...
          <div class="he_syp2mo wow g_fadeup1">
            <div class="he_syp2mob">
              ...
              <a href="<?php echo $field['typeurl']; ?>">More news</a>
              <?php endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>
            </div>
          </div>
        </div>
        ...
        <!-- <div class="he_syp2zs wow g_fadein1">
            <img src="<?php echo $GLOBALS['skin']; ?>img/syp2zs.png" alt="">
          </div> -->
      </section>
      ...
      <div class="zc">
        <div class="commen">
          <div class="bt aos-init" data-aos="fade-up">
            <p>Support & Service</p>
            <span></span>
          </div>
          <div class="zca">
            ...
            <div class="zca_a aos-init" data-aos="fade-up">
            ...
            <?php endif; else: echo htmlspecialchars_decode("");endif; $field = [];  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = "75"; endif; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $tagType = new \think\template\taglib\eyou\TagType; $_result = $tagType->getType($typeid, "self", ""); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator):  $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: $field = $__LIST__;?>
            ...
            <div class="zca_a aos-init" data-aos="fade-up">
              <a href="<?php echo $field['typeurl']; ?>">
                 <?php  $tagAdv = new \think\template\taglib\eyou\TagAdv; $_result = $tagAdv->getAdv(11, "", ""); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $e = 1;$__LIST__ = is_array($_result) ? array_slice($_result,0, 10, true) : $_result->slice(0, 10, true); if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field):  if ($i == 0) : $field["currentclass"] = $field["currentstyle"] = ""; else:  $field["currentclass"] = $field["currentstyle"] = ""; endif;$i= intval($key) + 1;$mod = ($i % 2 ); ?>
                  <img src='<?php echo $field['litpic']; ?>' alt='<?php echo $field['title']; ?>' />
                <?php ++$e; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>
                <h6>FAQs</h6>
                <!-- <p>1111111111</p> -->
      ...
      <section class="he_secton he_syp3">
        <div class="he_secton he_syp4" style="display: block">
          <div class="he_syp4bx">
            <div class="he_syp4bti">
              <div class="he_sytipu">
                <p>NEWSLETTER</p>
                <div class="he_syxijm">
                  <p>Get industrial insights and Afore news here.</p>
                </div>
              </div>
            </div>
            <div class="he_syp4in">
