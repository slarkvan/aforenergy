<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:30:"./template/pc/view_product.htm";i:1721267717;s:56:"/www/wwwroot/testweb.aforenergy.com/template/pc/head.htm";i:1726294558;s:58:"/www/wwwroot/testweb.aforenergy.com/template/pc/bottom.htm";i:1721290442;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8" />
        ...
        <div class="he_nybx">
          ...
          <div class="he_xgp1">
            <div class="he_xgp1ba">
              <!-- pc banner图 -->
              <div
                class="he_xgp1bl he_xgp1bapc"
                style="
                  background: url({eyou:globalname='web_templets_pc'/}/skin/img/re.jpeg) center /
                    cover no-repeat;
                "
              ></div>
              <!-- ph banner图 -->
              ...
              <!-- 视频 -->
              <video
                src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/re.mp4"
                class="he_c04vud"
                muted=""
                loop=""
              ></video>
                ...
                <div class="he_c04leti">
                  <div class="he_bantti1">
                    <h1><?php echo $eyou['field']['title']; ?></h1>
                     <p><?php echo $eyou['field']['cpdushu1']; ?></p>
                  </div>
                </div>
               
                <div class="he_c04letp">
                  <p><?php echo $eyou['field']['cpxinghao']; ?></p>
                </div>
                <div class="he_c04lekc clearfix">
                  <div class="he_c04lekb he_c04lekb1 fl">
                    <a href="<?php echo $eyou['field']['cpfujian']; ?>" target="_blank">Download PDF &gt;</a>
                  </div>
            ...
            <div class="s_cont1360">
                ...
                <div class="s_cont1360">
                  <div class="he_bordul clearfix">
                    <div class="he_bordfr fl">
                      <a href="/">
                        <img
                          src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/bordi1.svg"
                          alt=""
                          class="he_int1"
                        />
                        <img
                          src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/bordi2.svg"
                          alt=""
                          class="he_int2"
                        />
                      </a>
                    ...
                    <div class="he_bordli fl">
                      &gt;
                      <a href="#"> <?php  $typeid = ""; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $tagPosition = new \think\template\taglib\eyou\TagPosition; $__VALUE__ = $tagPosition->getPosition($typeid, "", " "); echo $__VALUE__; ?></a>
                    </div>
                  </div>
                </div>
              </div>
              <div class="he_xgp2le">
                <div class="he_xgp2jk wow g_fadeup1">
                  <p style="text-align: justify"><?php echo $eyou['field']['seo_description']; ?></p>
                ...
                <div class="he_xgp2ul clearfix">
                  ...
                  <div class="he_xgp2li fl wow g_fadeup1">
                    <div class="he_xgp2lkh">
                      ...
                      <img src="<?php echo $eyou['field']['liangdian1tubiao']; ?>" class="he_img1" />
                    </div>
                    <div class="he_xgp2lte">
                      <p><?php echo $eyou['field']['cpliangdian1']; ?></p>
                    </div>
                  </div>
                  <div class="he_xgp2li fl wow g_fadeup1">
                    <div class="he_xgp2lkh">
                      <img src="<?php echo $eyou['field']['lainlaingdian2tubiao']; ?>" alt="" class="he_img" />
                      <img src="<?php echo $eyou['field']['lainlaingdian2tubiao']; ?>" class="he_img1" />
                    </div>
                    <div class="he_xgp2lte">
                      <p><?php echo $eyou['field']['cpliangdian2']; ?></p>
                    </div>
                  </div>
                  <div class="he_xgp2li fl wow g_fadeup1">
                    <div class="he_xgp2lkh">
                      <img src="<?php echo $eyou['field']['liangdian3tubiao']; ?>" alt="" class="he_img" />
                      <img src="<?php echo $eyou['field']['liangdian3tubiao']; ?>" class="he_img1" />
                    </div>
                    <div class="he_xgp2lte">
                      <p><?php echo $eyou['field']['cpliangdian3']; ?></p>
                    </div>
                  </div>
                  <div class="he_xgp2li fl wow g_fadeup1">
                    <div class="he_xgp2lkh">
                      <img src="<?php echo $eyou['field']['liangdian4tubiao']; ?>" alt="" class="he_img" />
                      <img src="<?php echo $eyou['field']['liangdian4tubiao']; ?>" alt="" class="he_img1" />
                    </div>
                    <div class="he_xgp2lte">
                      <p><?php echo $eyou['field']['cpliangdian4']; ?></p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="he_c04c3n">
                <div class="he_c04c3kl">
                  <div class="he_c04p3kti wow g_fadeup1">
                    <h2 class="he_x40ft">Product introduction</h2>
                  </div>
    ...
    <script>
      ...
      function s1Text() {
        ...
        function getParam() {
          ...
          end = start + $('.he_b1s1').height() - $('.he_b1s1cv1').height();
        }
