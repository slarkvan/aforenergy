<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:30:"./template/pc/view_article.htm";i:1693559661;s:56:"/www/wwwroot/testweb.aforenergy.com/template/pc/head.htm";i:1726294558;s:58:"/www/wwwroot/testweb.aforenergy.com/template/pc/bottom.htm";i:1721290442;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
 <head> 
  <meta charset="utf-8" /> 
  ...
  <div class="ys_navph2_header">
   ...
   <div class="he_main"> 
    <div class="s_content"> 
     ...
     <div class="s_b2_3cont1 s_cont1206 clearfix jian1" data-sticky-container=""> 
      <div class="s_b2_3contr fr selector" data-margin-top="120"> 
       <div class="s_b2_3share"> 
        <div class="s_b2_3sharewz p16">
         Share
        </div> 
        <div class="s_b2_3sharebot"> 
         <div class="s_b2_3sharebox"> 
          <div class="s_b2_3sharenr he_ftbslt"> 
           <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/1.ins.svg" alt="douyin.svg" class="s_b2_3sharenr1" /> 
           <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/1.ins-180.svg" alt="douyin1.svg" class="s_b2_3sharenr2" /> 
          </div> 
        
         </div> 
         <div class="s_b2_3sharebox"> 
          <div class="s_b2_3sharenr he_ftbslt"> 
           <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/2.Facebook-888.svg" alt="shipinhao.svg" class="s_b2_3sharenr1" /> 
           <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/2.Facebook.svg" alt="shipinhao1.svg" class="s_b2_3sharenr2" /> 
          </div> 
          
         </div> 
         <div class="s_b2_3sharebox bshare-custom "> 
          <div class="s_b2_3sharenr"> 
           <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/3.twiter-248.svg" alt="weibo.svg" class="s_b2_3sharenr1" /> 
           <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/3.twiter.svg" alt="weibo1.svg" class="s_b2_3sharenr2" /> 
          </div> 
          
         </div> 
         <div class="s_b2_3sharebox bshare-custom "> 
          <div class="s_b2_3sharenr"> 
           <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/4.lingying-857.svg" alt="weixin.svg" class="s_b2_3sharenr1" /> 
           <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/4.lingying.svg" alt="weixin1.svg" class="s_b2_3sharenr2" /> 
          </div> 
          
         </div> 
          <div class="s_b2_3sharebox bshare-custom "> 
          <div class="s_b2_3sharenr"> 
           <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/youtobe%401x-759.svg" alt="weixin.svg" class="s_b2_3sharenr1" /> 
           <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/youtobe%401xyuanse-825.svg" alt="weixin1.svg" class="s_b2_3sharenr2" /> 
          </div> 
      ...
      <div class="s_b2_3contl fl"> 
       <div class="s_b2_3contltop"> 
        <div class="s_b2_3contltime p20">
          <?php echo MyDate('Y-m-d H:i:s',$eyou['field']['add_time']); ?>
        </div> 
        <div class="s_b2_3contltit font1 he_fonts"> 
         <h1><?php echo $eyou['field']['title']; ?></h1> 
        </div> 
     
       </div> 
       <div class="s_b2_3conlbjq pra yxedr_active"> 
        <p><span style="color: rgb(89, 89, 89); font-size: 14px;">

         <?php echo $eyou['field']['content']; ?>

        </p> 
       </div> 
       <div class="s_b2_3contlsx clearfix"> 
        <div class="s_b2_3contlsxnr fl"> 
    ...
    <a href="<?php echo $field['arcurl']; ?>">PREVIOUS : <?php echo $field['title']; ?></a>
<?php else: ?>
    <a></a>
<?php endif; $field = []; ?>
    ...
    <a href="<?php echo $field['arcurl']; ?>">NEXT : <?php echo $field['title']; ?></a>
<?php else: ?>
    <a></a>
<?php endif; $field = []; ?>
        </div> 
     ...
     <div class="s_b2_3cont2"> 
      <div class="s_b2_3c2nr s_cont1514"> 
       <div class="s_b2_3c2tit font1"> 
        <h2>Recommended</h2> 
       </div> 
       <div class="s_b2_3c2main clearfix"> 
  ...
  'r' => 'eyou:artlist',
  'row' => '3',
); $tagArclist = new \think\template\taglib\eyou\TagArclist; $_result = $tagArclist->getArclist($param, $row, "", "","desc","",$tag,"0","on","off","","");if(!empty($_result["list"]) && (is_array($_result["list"]) || $_result["list"] instanceof \think\Collection || $_result["list"] instanceof \think\Paginator)): $i = 0; $e = 1; $__LIST__ = is_array($_result["list"]) ? array_slice($_result["list"],0, $row, true) : $_result["list"]->slice(0, $row, true);  $__TAG__ = $_result["tag"];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $aid = $field["aid"];$users_id = $field["users_id"];$field["title"] = text_msubstr($field["title"], 0, 60, false);if($field["is_b"] == 1) : $field["title"] = "<strong>".$field["title"]."</strong>";endif;$field["seo_description"] = text_msubstr($field["seo_description"], 0, 160, true);$i= intval($key) + 1;$mod = ($i % 2 ); ?>
        <div class="s_b2_3c2list fl"> 
         <a href="<?php echo $field['arcurl']; ?>"> 
          <div class="s_b2_3c2li"> 
           ...
           <div class="s_b2_3c2libot clearfix"> 
            ...
            <div class="s_b2_2c2wztop p16 fr"> 
...
<script>
  console.log('%c', 'color:green')
     ...
     <?php  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/js/sticky.min.js","","","",""); echo $__VALUE__; ?>
  <script>
    new WOW().init();
</script> 
  <script>
  ...
  $(".s_b2_3c2main").slick({
    ...
    bShare.addEntry({
      title: encodeURI('分享到微博'),
      summary: encodeURI('随时随地分享身边的新鲜事'),
      // pic: encodeURI("http://qd.hongwenfeh.com/"+$(".w_d2_rightnr img").eq(0).attr("src"))
    });
