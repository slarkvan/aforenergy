<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:36:"./template/pc/lists_single_about.htm";i:1726310547;s:56:"/www/wwwroot/testweb.aforenergy.com/template/pc/head.htm";i:1726294558;s:58:"/www/wwwroot/testweb.aforenergy.com/template/pc/bottom.htm";i:1721290442;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
 <head>
  <meta charset="utf-8" />
...
})(window,document,'script','dataLayer','GTM-WQHVSVMT');</script>
<!-- End Google Tag Manager -->
<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-WQHVSVMT"
height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
<!-- End Google Tag Manager (noscript) -->
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-16670008930"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'AW-16670008930');
</script>
<!-- Event snippet for 表单提交 conversion page -->
<script>
  gtag('event', 'conversion', {'send_to': 'AW-16670008930/dZxaCNH0h8sZEOLM8Iw-'});
</script>
<script>
  gtag('event', 'conversion', {'send_to': 'AW-16670008930/H9epCNT0h8sZEOLM8Iw-'});
</script>
<!-- 语言 -->
<div class="he_index">
  <!-- pc顶部导航 -->
            ...
            <div class="he_langgul clearfix">
              <div class="he_langgli fl">
                <div class="he_lanjx">
                  ...
                  <div class="he_lanjd">
                    <p>
                      <a href="https://www.aforenergy.com">English (Global)</a>
                    </p>
                  </div>
                  
                  <div class="he_lanjd">
                    <p>
                      <a href="https://cn.aforenergy.com">中文</a>
                    </p>
                  </div>
                </div>
              </div>
              <div class="he_langgli fl">
                <div class="he_lanjx">
                  ...
                  <div class="he_lanjd">
                    <p>
                      <a href="https://www.aforenergy.com">English</a>
                    </p>
                  </div>
                  <!--<div class="he_lanjd">-->
                  <!--  <p>-->
    ...
    <div class="he_pcbx">
      <div class="he_pcbxn clearfix">
        <div class="he_pcbxle fl">
          <a href="/">
            <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/logo20221208.svg" class="he_img"
        ...
        <div class="he_pcbxri fr clearfix">
          <div class="he_pcnav clearfix fl">
                          ...
                          <div class="he_xialali fl">
                            <div class="he_xialach">
                              <a href="<?php echo $field['typeurl']; ?>" target="_self" class="clearfix">
                                ...
                                <div class="he_xialacri fl" style="width: fit-content;">
            ...
            <div class="he_pcnli fl">
              ...
              <?php endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>
              <!-- 产品下拉 -->
              <div class="he_gdown he_gdown2" style="padding-top: 20px; padding-bottom: 30px">
                <div class="he_conten3">
                      ...
                      <div class="he_laswkf">
                        ...
                        <div class="he_laswkfli clearfix act">
                          <div class="he_laswkfle fl">
                            <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/daohang1.svg" alt="fw.svg" />
                          </div>
                        ...
                        <div class="he_laswkfli clearfix">
                          <div class="he_laswkfle fl">
                            <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/daohang2.svg" alt="wuding.svg" />
                          </div>
                          <div class="he_laswkfri fl">
                            <a href="<?php echo $field['typeurl']; ?>" target="_self">
                              <p><?php echo $field['typename']; ?></p>
                        ...
                        <div class="he_laswkfli clearfix">
                          <div class="he_laswkfle fl">
                            <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/daohang3.svg" alt="wuding.svg" />
                          </div>
                          <div class="he_laswkfri fl">
                            <a href="<?php echo $field['typeurl']; ?>" target="_self">
                              <p><?php echo $field['typename']; ?></p>
                        ...
                        <div class="he_laswkfli clearfix">
                          <div class="he_laswkfle fl">
                            <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/daohang4.svg" alt="dianli.svg" />
                          </div>
                          <div class="he_laswkfri fl">
                            <a href="<?php echo $field['typeurl']; ?>" target="_self">
                              <p><?php echo $field['typename']; ?></p>
                        ...
                        <div class="he_laswkfli clearfix">
                          <div class="he_laswkfle fl">
                            <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/daohang5.svg" alt="dianli.svg" />
                          </div>
                          <div class="he_laswkfri fl">
                            <a href="<?php echo $field['typeurl']; ?>" target="_self">
                              <p><?php echo $field['typename']; ?></p>
                        ...
                        <div class="he_laswkfli clearfix">
                          <div class="he_laswkfle fl">
                            <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/daohang6.svg" alt="dianli.svg" />
                          </div>
                          <div class="he_laswkfri fl">
                            <a href="<?php echo $field['typeurl']; ?>" target="_self">
                              <p><?php echo $field['typename']; ?></p>
                        ...
                        <div class="he_laswkfli clearfix">
                          <div class="he_laswkfle fl">
                            <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/daohang7.svg" alt="dianli.svg" />
                          </div>
                          <div class="he_laswkfri fl">
                            <a href="<?php echo $field['typeurl']; ?>" target="_self">
                              <p><?php echo $field['typename']; ?></p>
                    ...
                    <div class="he_xialtwri fl">
                      ...
                      <div class="he_xialwxul">
                        <div class="he_xialtrul clearfix">
                          <?php  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = "20"; endif; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  if(isset($ui_row) && !empty($ui_row)) : $row = $ui_row; else: $row = 60; endif; $modelid = ""; $param = array(      "typeid"=> $typeid,      "notypeid"=> "",      "flag"=> "c",      "noflag"=> "",      "channel"=> $modelid,      "joinaid"=> "",      "keyword"=> "",      "release"=> "off",      "idlist"=> "",      "idrange"=> "",      "aid"=> "", ); $tag = array (
  'loop' => '60',
  'typeid' => '20',
  'orderby' => 'new',
  'ordermode' => 'asc',
  ...
  'r' => 'eyou:artlist',
  'row' => '60',
); $tagArclist = new \think\template\taglib\eyou\TagArclist; $_result = $tagArclist->getArclist($param, $row, "", "","asc","",$tag,"0","on","off","","");if(!empty($_result["list"]) && (is_array($_result["list"]) || $_result["list"] instanceof \think\Collection || $_result["list"] instanceof \think\Paginator)): $i = 0; $e = 1; $__LIST__ = is_array($_result["list"]) ? array_slice($_result["list"],0, $row, true) : $_result["list"]->slice(0, $row, true);  $__TAG__ = $_result["tag"];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $aid = $field["aid"];$users_id = $field["users_id"];$field["title"] = text_msubstr($field["title"], 0, 100, false);if($field["is_b"] == 1) : $field["title"] = "<strong>".$field["title"]."</strong>";endif;$field["seo_description"] = text_msubstr($field["seo_description"], 0, 160, true);$i= intval($key) + 1;$mod = ($i % 2 ); ?>
  ...
  'row' => '60',
            ...
            <div class="he_pcnli fl">
              ...
              <a href="index.php?m=home&c=Lists&a=index&tid=72" target="_self" class="he_pcnava">Support & Service</a>
              <?php endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>

              <!-- 下拉 -->
              <div class="he_gdown he_gdown5">
                <div class="he_conten3" style="width: 100%; margin: 5px auto 10px auto">
                  <div class="he_xlatr clearfix">
                    <div class="he_xiala clearfix fl" style="width: 100%">
                      <div class="he_xialale">
                        <div class="he_xialaul clearfix"
                          style="display: flex; align-items: center; justify-content: space-between">
                          <div class="he_xialali fl" style="width: fit-content">
                            ...
                            <div class="he_xialach">
                              <a href="<?php echo $field['typeurl']; ?>" target="_self" class="clearfix">
                               <div class="he_xialacle fl">
                                ...
                                <div class="he_xialacri fl" style="width: 100%; padding: 0;padding-left: 20px;">
                                  <p>Download</p>
                                </div>
                              </a>
                            </div>
                          ...
                          <div class="he_xialali fl" style="width: fit-content">
                            ...
                            <div class="he_xialach">
                              <a href="https://pr.aforenergy.com/login" target="_blank" class="clearfix">
                              <div class="he_xialacle fl">
                                  <!--<img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/1-187.png" />-->
                                   <img src="<?php echo $field['icon']; ?>" />
                                </div>
                                <div class="he_xialacri fl" style="width: 100%; padding: 0;padding-left: 20px;">
                                  <p>Monitoring For Business</p>
                                </div>
                              </a>
                            </div>
                             <?php endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>
                          ...
                          <div class="he_xialali fl" style="width: fit-content">
                            ...
                            <div class="he_xialach">
                              <a href="https://hom.aforenergy.com/login" target="_blank" class="clearfix">
                                <div class="he_xialacle fl">
                                  <!--<img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/1-187.png" />-->
                                   <img src="<?php echo $field['icon']; ?>" />
                                </div>
                                <div class="he_xialacri fl" style="width: 100%; padding: 0;padding-left: 20px;">
                                  <p>Monitoring For End User</p>
                                </div>
                              </a>
                            </div>
                            <?php endif; else: echo htmlspecialchars_decode("");endif; $field = []; ?>
              ...
              <div class="mc_scm_container mc_pos_center">
                <form class="mc_scm_form" onsubmit="return false">
                  <div class="mc_msc_box">
                    <input type="text" placeholder="Please enter..." class="mc_msc_input" autocomplete="off"
                      id="keywords" />
  ...
  <div class="ys_navph2_header">
    ...
    <div class="ys_navph2_list">
      <ul class="ys_navph2_subnav">
        ...
        <li class="ys_navph2_subnav_li">
          <div class="ys_navph2_subnav_lisbox">
            <a href="<?php echo $field['typeurl']; ?>" target="_self" class="ys_navph2_subnav_a">
          ...
          <ul class="ys_navph2_thirnav">
            ...
            <li class="ys_navph2_thirnav_li">
              <div class="ys_navph2_thirnav_lisbox">
                <a href="<?php echo $field2['typeurl']; ?>" target="_self" class="ys_navph2_thirnav_a">
                  <?php echo $field2['typename']; ?>
                </a>
              </div>
              <!-- 四级 -->
              <ul class="ys_navph2_fournav"></ul>
            </li>
        ...
        <ul class="ys_navph2_subnav">
          <li class="ys_navph2_subnav_li">
            ...
            <ul class="ys_navph2_thirnav">
              <li class="ys_navph2_thirnav_li">
                <div class="ys_navph2_thirnav_lisbox">
                  <a href="https://www.aforenergy.com" target="_self" class="ys_navph2_thirnav_a">English (Global)</a>
                </div>
              </li>
              <li class="ys_navph2_thirnav_li">
                <div class="ys_navph2_thirnav_lisbox">
              ...
              <li class="ys_navph2_thirnav_li">
                <div class="ys_navph2_thirnav_lisbox">
                  <a href="https://www.afore.co.jp/" target="_blank" class="ys_navph2_thirnav_a">
                    日本語
                  </a>
                </div>
              </li>
      ...
      <div class="he_main">
        <div class="s_content">
          ...
          <div class="he_bordkm">
            ...
            <div class="s_b1_3cont3">
                    <div class="s_b1_3c3box s_cont1360">
                        <div class="he_b1p3ti wow g_fadeup1">
                            <h2 class="he_x40ft">Afore is a leading photovoltaic inverter supplier in China</h2>
                        </div>
                        <div class="s_b1_3c3 clearfix">
                            <div class="s_b1_3c3nr fl wow g_fadeup1">
                                <div class="s_b1_3c3ig">
                                    <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/abzuo01.png" alt="" class="s_b1_3c3ig1">
                                    <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/abzuo01.png" alt="55.png" class="s_b1_3c3ig2">
                                </div>
                                <div class="s_b1_3c3tit font1">
                                    <h5>Our Vision</h5>
                                </div>
                                <div class="s_b1_3c3xian"></div>
                                <div class="s_b1_3c3nrp">
                                    <p>
                                       To be a leading force in renewable energy, advancing innovative technologies that contribute to a sustainable future and preserving the environment for future generations.                                  </p>
                                </div>
                            </div><div class="s_b1_3c3nr fl wow g_fadeup1">
                                <div class="s_b1_3c3ig">
                                    <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/abzhong01.png" alt="" class="s_b1_3c3ig1">
                                    <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/abzhong01.png"  alt="57.png" class="s_b1_3c3ig2">
                                </div>
                                <div class="s_b1_3c3tit font1">
                                    <h5>Our Mission</h5>
                                </div>
                                ...
                                <div class="s_b1_3c3nrp">
                                    <p>
                                        To develop and deliver cutting-edge, low-carbon, and environmentally-friendly solar inverter and energy stoage solutions that drive the transition to clean energy and enhance the quality of life globally.
                                  </p>
                                </div>
                            </div><div class="s_b1_3c3nr fl wow g_fadeup1">
                                <div class="s_b1_3c3ig">
                                    <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/abyou01.png" width="120px" alt="" class="s_b1_3c3ig1">
                                    <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/abyou01.png" width="120px" alt="56.png" class="s_b1_3c3ig2">
                                </div>
                                <div class="s_b1_3c3tit font1">
                                    <h5>Our Values</h5>
                                </div>
                                ...
                                <div class="s_b1_3c3nrp">
                                    <p>
                                        Innovation, Sustainability, Integrity, Customer Focus, Excellence                                     </p>
                                </div>
                            </div>                        </div>
                    </div>
                </div>
          ...
          <div class="he_b1p4js wow g_fadein1" style="background: url(<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/b1xym.png) center / cover no-repeat;">
            <div class="s_cont1360">
              <div class="he_b1p4jsxt wow g_fadeup1">
                <p>
                </p>
              </div>
              <div class="he_b1p4jsdt wow g_fadeup1">
                <h2 class="he_x40ft">
                 Corporate Culture
                </h2>
              </div>
          ...
          <div class="s_b1_3cont4">
            <div class="s_b1_3c4 s_cont1360 wow g_fadein1">
              <div class="s_b1_3c4box">
                <div class="s_b1_3c4bg">
                  <div class="he_b1tulb">
                    <div class="he_b1tuli">
                      <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/333-141.jpeg" alt="333-141.jpg">
                    </div>
                    <div class="he_b1tuli">
                      <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/333-405.jpeg" alt="333-405.jpg">
                    </div>
                    <!--<div class="he_b1tuli">-->
                    <!--  <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/333-285.jpeg" alt="333-285.jpg">-->
                    <!--</div>-->
                  </div>
                </div>
                <div class="s_b1_3c4nrbox">
                  <div class="s_b1_3c4nr clearfix">
                    <div class="s_b1_3c4nrr fr">
                      <div class="s_b1_3c4nrrtpbox">
                        <div class="s_b1_3c1playan">
                          <div class="s_b1_3c1playig">
                            <div class="s_b1_3c1playigbox">
                              <img class="s_b1_3play_zt" src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/01.svg" alt="01.svg">
                            </div>
                          </div>
                          <!-- 动感圈圈 -->
                          <div class="s_syqq_act">
                            <svg class="fp-arc-loader" width="61" height="63">
                              <circle class="arc" cx="32.5" cy="26.6" r="28" fill="none" stroke-dasharray="0, 0"
                              stroke-dashoffset="5" transform="rotate(-285 28 28)" stroke="#e60012" stroke-opacity="1"
                              stroke-width="4px" style="stroke-dashoffset:182.8644px; stroke-dasharray: 176.2px, 182.8644px;">
                              </circle>
                            </svg>
                          </div>
                        </div>
                      </div>
                      <div class="s_b1_3c4tit">
                        <h3>
                          CEO's Message
                        </h3>
                      </div>
                      <div class="s_b1_3c4nrrp pra1">
                        <p>
                    ...
                    <div class="s_b1_3c4nrl fr">
                      <div class="s_b1_3c4nrltw">
                        <a href="#" class="clearfix">
                          <div class="s_b1_3c4nrltwigbox fl">
                            <div class="s_syqq_act">
                            </div>
                            <div class="s_b1_3c4nrltwig">
                              <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/b1_3c4icon1-25.svg" alt="b1_3c4icon1-25.svg">
                            </div>
                          </div>
                          <div class="s_b1_3c4nrltwz fr">
                           Smart Energy
                          </div>
                        </a>
                      </div>
                    ...
                    <div class="s_b1_3c4nrr fr">
                      <div class="s_b1_3c4nrrtpbox">
                        <div class="s_b1_3c1playan">
                          <div class="s_b1_3c1playig">
                            <div class="s_b1_3c1playigbox">
                              <img class="s_b1_3play_zt" src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/02.svg" alt="">
                            </div>
                          </div>
                          <!-- 动感圈圈 -->
                          <div class="s_syqq_act">
                      ...
                      <div class="s_b1_3c4nrltw">
                        <a href="#" target="_blank" class="clearfix">
                          <div class="s_b1_3c4nrltwigbox fl">
                            ...
                            <div class="s_b1_3c4nrltwig">
                              <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/b1_3c4icon1_1.svg" alt="b1_3c4icon1.svg">
                            </div>
                          </div>
                          <div class="s_b1_3c4nrltwz fr">
                           Smart Energy
                ...
                <div class="s_b1_3c4mc">
                  <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/b1_3c4img1.png" alt="">
                </div>
              </div>
              <div class="he_b1p4bx">
                <div class="he_b1p4bxti wow g_fadeup1">
                  <h2 class="he_x40ft">
                    About Us
                  </h2>
                </div>
                <div class="he_b1p4bjgk wow g_fadeup1">
                  <p>
          ...
          <div class="s_b1_3cont5">
            <div class="s_b1_3c5 s_cont1360 jian1">
              <div class="s_d2c1tit font1 wow g_fadeup1">
                <h2>
                  Honor
                </h2>
              </div>
              <div class="s_b1_3c5bot clearfix wow g_fadeup1">
               <?php  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = "78"; endif; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  if(isset($ui_row) && !empty($ui_row)) : $row = $ui_row; else: $row = 10; endif; $modelid = ""; $param = array(      "typeid"=> $typeid,      "notypeid"=> "",      "flag"=> "",      "noflag"=> "",      "channel"=> $modelid,      "joinaid"=> "",      "keyword"=> "",      "release"=> "off",      "idlist"=> "",      "idrange"=> "",      "aid"=> "", ); $tag = array (
  'loop' => '10',
  'typeid' => '78',
  'r' => 'eyou:artlist',
  'row' => '10',
                ...
                <div class="s_b1_3c5list fl">
                  <div class="s_b1_3c5listig">
                    <img src="<?php echo $field['litpic']; ?>" alt="" class="s_b1_3c5listig1">
                    <img src="<?php echo $field['litpic']; ?>" alt="" class="s_b1_3c5listig2">
                  </div>
                  <div class="s_b1_3c5xian">
                    <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/b1_3c5xian.png" alt="">
                  </div>
                  <div class="s_b1_3c5time font1">
                    <h4>
                     <?php  $aid = $field['aid']; $tagField = new \think\template\taglib\eyou\TagField; $__VALUE__ = $tagField->getField("ryshijian", $aid); echo $__VALUE__; unset($aid); ?>
                    </h4>
                  </div>
                  <div class="s_b1_3c5listnr">
                    <p>
...
<script>
  console.log('%c', 'color:green')
    ...
    <script>
      // banner视频手机端播放
if ($(window).width() > 1024 && $('.he_banig video').length > 0) {
    $('.he_banig video').get(0).play();
}
// 数字滚动
$(".s_b1_3c2sj span").appear(function() {
    var count = $(this).text();
    var counts = parseInt(count.replace(/,/, ""));
    $(this).countTo({
        form: 1,
...
$(function() {
    ...
    $(".s_b1_3c1mainrwzbox").on('afterChange', function(event, slick, currentSlide, nextSlide) {
        var index = currentSlide;
        $(".s_b1_3c1 .s_syqq_act .arc").css({
            strokeDashoffset: 157.8644,
        })
        $(".s_b1_3c1 .s_syqq_act .arc").addClass("act");
        setTimeout(function() {
            $(".s_b1_3c1 .s_syqq_act .arc").removeClass("act");
        }, 500);
...
$(function() {
    ...
    $('.he_b1tulb').slick({
        ...
        pauseOnHover: false,
        fade: true,
        asNavFor: '.s_b1_3c4nrbox',
    });

    $(".s_b1_3c4nrbox").on('afterChange', function(event, slick, currentSlide, nextSlide) {
        var index = currentSlide;
        $(".s_b1_3c4nrbox .s_syqq_act .arc").css({
            strokeDashoffset: 182.864,
        })
        $(".s_b1_3c4nrbox .s_syqq_act .arc").addClass("act");
        setTimeout(function() {
            $(".s_b1_3c4nrbox .s_syqq_act .arc").removeClass("act");
        }, 500);
    });
})

var btna = true;
$('.s_b1_3c1 .s_b1_3c1playan').click(function() {
    $(this).toggleClass('atvc');
    if (btna) {
        $('.s_b1_3c1mainrwzbox').slick('slickPause');
    } else {
        $('.s_b1_3c1mainrwzbox').slick('slickPlay');
    }
    btna = !btna;
})
    </script>
