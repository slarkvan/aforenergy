<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:27:"./template/mobile/index.htm";i:1694417357;s:60:"/www/wwwroot/testweb.aforenergy.com/template/mobile/head.htm";i:1702175699;s:62:"/www/wwwroot/testweb.aforenergy.com/template/mobile/bottom.htm";i:1694417357;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
...
" target="_blank"  style="color: #000000;line-height: 1.5;" >   Monitoring For Business </a>
      ...
      <div class="he_banbx">
        <div class="he_banul">
          ...
          <div class="he_banli">
            <div class="he_banig">
             <!--  <img src="<?php echo $GLOBALS['skin']; ?>img/banner001.jpg" class="he_banpc" alt="1.1.jpg"> -->
              ...
              <!-- 手机端 -->
               <video src="http://1251075830.vod2.myqcloud.com/8af421dfvodgzp1251075830/894e9da25576678021016298013/gslyGjMq5vsA.mp4" muted=""></video> 
            </div>
            <!-- banner文字 -->
            <div class="he_bante">
              <div class="he_conten1">
                <div class="he_bantnv">
                  ...
                  <div class="he_bantti2">
                    <p>Return the earth to a blue sky and become the world's most valuable green energy enterprise</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="he_banli">
            <a href="#">
              <div class="he_banig">
                ...
                <img src="<?php echo $field['litpic']; ?>" class="he_banph" alt=""><!-- 手机端 -->
              </div>
              <!-- banner文字 -->
              <div class="he_bante">
                <div class="he_conten1">
      ...
      <div class="he_main">
       ...
       <div class="jj">
            ...
            <div class="jja">
                <div class="jjb fl" style="background-image: url('<?php  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/img/shouyecp001.jpg","","","",""); echo $__VALUE__; ?>');">
                    ...
                    <div class="jjb fl" style="background-image: url('<?php  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/img/shouyecp002.jpg","","","",""); echo $__VALUE__; ?>');">
                    <a href="#">
                        <h5>02</h5>
                   ...
                   <div class="jjb fl" style="background-image: url('<?php  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/img/shouyecp003.jpg","","","",""); echo $__VALUE__; ?>');">
                    <a href="#">
                        <h5>03</h5>
                  ...
                  <div class="jjb fl" style="background-image: url('<?php  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/img/shouyecp004.jpg","","","",""); echo $__VALUE__; ?>');">
                    <a href="#">
                        <h5>04</h5>
                ...
                <div class="zca">
                    ...
                    <div class="zca_a aos-init" data-aos="fade-up">
                        <a href="<?php echo $field['typeurl']; ?>">
                            <img src="<?php  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/img/Download2.png","","","",""); echo $__VALUE__; ?>"> 
                    ...
                    <div class="zca_a aos-init" data-aos="fade-up">
                        <a href="<?php echo $field['typeurl']; ?>">
                              ...
                              <img src="<?php  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/img/Warranty2.png","","","",""); echo $__VALUE__; ?>"> 
                            <h6><?php echo $field['typename']; ?></h6>
                           <!--  <p>11111111111111</p> -->
                        </a>
                    </div>
                    ...
                    <div class="zca_a aos-init" data-aos="fade-up">
                        <a href="<?php echo $field['typeurl']; ?>">
                             ...
                             <img src="<?php  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/img/Online Support2.png","","","",""); echo $__VALUE__; ?>"> 
                            <h6><?php echo $field['typename']; ?></h6>
                            <!-- <p>1111111111111</p> -->
                        </a>
                    </div>
                    ...
                    <div class="zca_a aos-init" data-aos="fade-up">
                        <a href="<?php echo $field['typeurl']; ?>">
                             ...
                             <img src="<?php  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/img/Monitoring Login2.png","","","",""); echo $__VALUE__; ?>"> 
                            <h6><?php echo $field['typename']; ?></h6>
                            <!-- <p>1111111111</p> -->
                        </a>
                    </div>
                    ...
                    <div class="zca_a aos-init" data-aos="fade-up">
                        <a href="<?php echo $field['typeurl']; ?>">
                             ...
                             <img src="<?php  $tagStatic = new \think\template\taglib\eyou\TagStatic; $__VALUE__ = $tagStatic->getStatic("skin/img/FAQs2.png","","","",""); echo $__VALUE__; ?>"> 
                            <h6><?php echo $field['typename']; ?></h6>
                            <!-- <p>1111111111</p> -->
                        </a>
                    </div>
