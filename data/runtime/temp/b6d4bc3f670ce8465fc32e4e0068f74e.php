<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:37:"./template/mobile/lists_article_q.htm";i:1694417357;s:60:"/www/wwwroot/testweb.aforenergy.com/template/mobile/head.htm";i:1702175699;s:62:"/www/wwwroot/testweb.aforenergy.com/template/mobile/bottom.htm";i:1694417357;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
    <head>
        <meta charset="utf-8" />
      ...
      <div class="he_conten1"> 
       <div class="he_bantnv"> 
        <div class="he_bantti1"> 
         <h1> <p><?php echo $eyou['field']['typename']; ?> </p> </h1> 
        </div> 
       </div> 
      </div> 
     </div> 
   ...
   <div class="he_main"> 
    <div class="s_content"> 
     ...
     <div class="s_d2content s_d3content"> 
      ...
      <div class="s_d2cont1 s_cont1514"> 
       ...
       <div class="s_d3cont clearfix"> 
        <div class="s_d3contl fl"> 
         ...
         <?php  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = "84"; endif; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $tagType = new \think\template\taglib\eyou\TagType; $_result = $tagType->getType($typeid, "self", ""); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator):  $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: $field = $__LIST__;?>
         <div class="s_d3contlnr act wow g_fadeup1"> 
          <a href="javascript:;"> 
           <div class="s_d3conttw clearfix"> 
            <div class="s_d3contwig"> 
             <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/d3_icon1.svg" alt="d3_icon1.svg" /> 
            </div> 
        ...
        <?php endif; else: echo htmlspecialchars_decode("");endif; $field = [];  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = "84"; endif; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $tagType = new \think\template\taglib\eyou\TagType; $_result = $tagType->getType($typeid, "self", ""); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator):  $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: $field = $__LIST__;?>
         ...
         <div class="s_d3contlnr  wow g_fadeup1"> 
          <a href="javascript:;"> 
           <div class="s_d3conttw clearfix"> 
            <div class="s_d3contwig"> 
             <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/d3_icon2.svg" alt="d3_icon2.svg" /> 
            </div> 
            <div class="s_d3contwz font1 fr"> 
             <h4><?php echo $field['typename']; ?></h4> 
            </div> 
      ...
      <!--    {loop table="classtype" tid="73" body="1" not="1" as="v"}
         <div class="s_d3contlnr  wow g_fadeup1"> 
          <a href="javascript:;"> 
           <div class="s_d3conttw clearfix"> 
            <div class="s_d3contwig"> 
             <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/changjianwenti.svg" alt="changjianwenti.svg" /> 
            </div> 
            <div class="s_d3contwz font1 fr"> 
             <h4><?php echo $v['classname']; ?></h4> 
            </div> 
           </div> </a> 
         </div>
          {/loop}
      ...
      <!--   <div class="s_d3contr fr"> 
         <div class="s_d3contrnr yxedr_active font1 g_fadeup1"> 


          
          <p><span style="font-size: 16px;"><strong>wenti
      ...
      <!--    <div class="s_d3contrnr yxedr_active font1 g_fadeup1"> 
          {loop table="channel" molds="nwenda" tid="73" orderby="id|asc" limit="50" as="v" }
          <p><span style="font-size: 16px;"><strong><?php echo $v['title']; ?></strong></span></p>
          <p>Answer：<?php echo $v['wdhuida']; ?></p>
          <p><br /></p>
           {/loop}
