<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:32:"./template/pc/lists_download.htm";i:1725939859;s:56:"/www/wwwroot/testweb.aforenergy.com/template/pc/head.htm";i:1726294558;s:58:"/www/wwwroot/testweb.aforenergy.com/template/pc/bottom.htm";i:1721290442;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
      ...
      <div class="ys_navph2_lang_modal">
        ...
        <div class="he_main">
            <div class="he_dxlnyq">
                    ...
                    <div class="s_cont1360">
                        <div class="he_bordul clearfix">
                            <div class="he_bordfr fl">
                                <a href="/"> <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/bordi1.svg"
                                        alt="" class="he_int1" /> <img
                                        src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/bordi2.svg" alt=""
                                        class="he_int2" /> </a>
                            </div>
                ...
                <!--    <div class="s_qhnr new <?php if($eyou['field']['typeid'] === $field['typeid']): ?> act <?php endif; ?>">-->
                ...
                <div class="he_d1ylz">
                    <!-- 检索条件 -->
                    <div class="he_d1yp1" style="display: none;">
                                        ...
                                        <div class="he_d1p1nli he_d1p1nli1 clearfix">
                                            ...
                                            <div class="he_d1p1nri fl">
                                                <div class="he_d1p1nol clearfix">
                                                    <?php  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = "72"; endif; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  if(isset($ui_row) && !empty($ui_row)) : $row = $ui_row; else: $row = 100; endif; $tagChannel = new \think\template\taglib\eyou\TagChannel; $_result = $tagChannel->getChannel($typeid, "son", "", ""); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $e = 1;$__LIST__ = is_array($_result) ? array_slice($_result,0, $row, true) : $_result->slice(0, $row, true); if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $field["typename"] = text_msubstr($field["typename"], 0, 100, false); $__LIST__[$key] = $_result[$key] = $field;$i= intval($key) + 1;$mod = ($i % 2 ); ?>
                                                    <div class="he_d1p1njx he_d1p1si fl clearfix get_type <?php if($eyou['field']['typeid'] === $field['typeid']): ?> act <?php endif; ?>"
                                                        data-id="<?php  $__VALUE__ = isset($channelartlist["typeid"]) ? $channelartlist["typeid"] : "变量名不存在"; echo $__VALUE__; ?>" data-type="one">
                                                        <div class="he_d1p1cjx fl">
                                                            <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/duihao.svg"
                                                                alt="" class="he_img">
                                                            <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/jiahao.svg"
                                                                alt="" class="he_img1">
                                                        </div>
                    ...
                    <div class="he_d1yp2 he_d1bxli" data-num="1">
                        ...
                        <div class="he_d1yp2ul">
                            ...
                            <div class="he_d1yp2tou clearfix wow g_fadeup1">
                                <div class="he_d1yp2tz he_d1yp2t1 fl" style="width: 100% !important;">
                                    ...
                                    <div class="s_qhnr new <?php if($eyou['field']['typeid'] === $field['typeid']): ?> act <?php endif; ?>" >
                                     ...
                                     <?php endif; else: echo htmlspecialchars_decode("");endif; $field = [];  if(isset($ui_typeid) && !empty($ui_typeid)) : $typeid = $ui_typeid; else: $typeid = "72"; endif; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  if(isset($ui_row) && !empty($ui_row)) : $row = $ui_row; else: $row = 100; endif; $tagChannel = new \think\template\taglib\eyou\TagChannel; $_result = $tagChannel->getChannel($typeid, "son", "", ""); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $e = 1;$__LIST__ = is_array($_result) ? array_slice($_result,0, $row, true) : $_result->slice(0, $row, true); if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $field["typename"] = text_msubstr($field["typename"], 0, 100, false); $__LIST__[$key] = $_result[$key] = $field;$i= intval($key) + 1;$mod = ($i % 2 ); ?>
                                     <div class="s_qhnr new <?php if($eyou['field']['typeid'] === $field['typeid']): ?> act <?php endif; ?>" style="padding:10px 15px;">
                                        <a href="<?php echo $field['typeurl']; ?>" >
                                        <?php echo $field['typename']; ?>
                                        </a>
                                     </div>
                           ...
                           <div class="he_d1yp2ul" style="padding-top:10px">
                            ...
                            <div class="he_d1yp2tou clearfix wow g_fadeup1">
                                <div class="he_d1yp2tz he_d1yp2t1 fl" style="width: 100% !important;">
                                    ...
                                    <!--调取模型自定字段，作为筛选条件，一下代码没成功-->
                                    <?php  $tagScreening = new \think\template\taglib\eyou\TagScreening; $_result = $tagScreening->getScreening("act", "Documenttype", "", "All", "");if(!empty($_result["list"]) || (($_result["list"] instanceof \think\Collection || $_result["list"] instanceof \think\Paginator ) && $_result["list"]->isEmpty())): $field = $_result; ?>
                                    <div class="he_quline new">
                                        <?php if(is_array($field['list']) || $field['list'] instanceof \think\Collection || $field['list'] instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $field['list'];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$vo): $i= intval($key) + 1;$mod = ($i % 2 ); if(is_array($vo['dfvalue']) || $vo['dfvalue'] instanceof \think\Collection || $vo['dfvalue'] instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $vo['dfvalue'];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$val): $i= intval($key) + 1;$mod = ($i % 2 ); ?>
                                                <div class="s_qhnr new <?php echo $val['currentclass']; ?>" style="padding:10px 15px;">
                                                   <a <?php echo $val['onClick']; ?> >
                                                    <?php echo $val['name']; ?>
                                                   </a>
                                                </div>
                                ...
                                <div class="he_d1yp2bl clearfix wow g_fadeup1">
                                    ...
                                    <div class="he_d1yp2tz he_d1yp2t2 fl">
                                      ...
                                      <div class="he_d1yp2tz he_d1yp2t5 fl">
                                        ...
                                        <a href="<?php echo $vo['file_url']; ?>" data-type="<?php echo $vo['file_type']; ?>" target="_blank">
                                            <?php echo $vo['server_name']; ?>
                                        </a>
                                        ...
                                        <!--<a href="<?php echo $field['downurl']; ?>" target="_blank">-->
                                        <!--    Download-->
                                        <!--</a>-->
