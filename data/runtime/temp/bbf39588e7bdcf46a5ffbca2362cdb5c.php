<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:34:"./template/pc/lists_warranty_a.htm";i:1726286365;s:56:"/www/wwwroot/testweb.aforenergy.com/template/pc/head.htm";i:1726294558;s:58:"/www/wwwroot/testweb.aforenergy.com/template/pc/bottom.htm";i:1721290442;}*/ ?>
<!--
 * @Author: ZhouQishun
 * @Date: 2023-12-26 06:33:29
 * @LastEditTime: 2024-01-04 15:13:53
 * @LastEditors: ZhouQishun
 * @Description: 1.0.0
 * @FilePath: \afceshixin.weibaoke.com.cn\template\pc\lists_warranty_a.htm
 *
-->
<!DOCTYPE html>
<html lang="zh-CN">
        ...
        <div class="he_k5p3">
            <div class="he_k5p3ti">
                <div class="he_k5p2ti">
                    ...
                    <h2 class="he_x40ft" style="font-size: 16px;color: #e50011;">Download</h2>
                    <?php endif; ?>
                </div>
                <div class="he_b1p4bjgk wow g_fadeup1" style="width: 100%;
    position: relative;
    margin-top: 64px;
    padding: 0 80px;
    padding-bottom: 70px;">
...
<script>
    $('.sao-box').on('click', function () {
        ...
        if (trim($code.val()).length < 4 || trim($code.val()).length > 20) {
            ...
            // var url = "<?php echo url('View/index','sn_code=c_code'); ?>";
