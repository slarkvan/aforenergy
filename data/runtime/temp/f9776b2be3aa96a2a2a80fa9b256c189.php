<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:52:"./application/admin/template/uploadimgnew/upload.htm";i:1692265102;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <script type="text/javascript" src="/public/plugins/uploadimgnew/js/upload.js?v=<?php echo $version; ?>0"></script>
    </body>
</html>
