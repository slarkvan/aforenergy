<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:45:"./application/admin/template/article/edit.htm";i:1692871658;s:80:"/www/wwwroot/testweb.aforenergy.com/application/admin/template/public/layout.htm";i:1692667952;s:83:"/www/wwwroot/testweb.aforenergy.com/application/admin/template/public/theme_css.htm";i:1680508822;s:98:"/www/wwwroot/testweb.aforenergy.com/application/admin/template/archives/get_field_addonextitem.htm";i:1680508822;s:80:"/www/wwwroot/testweb.aforenergy.com/application/admin/template/public/footer.htm";i:1680508822;}*/ ?>
<!doctype html>
<html>
<head>
...
<div id="page_div" class="page min-hg-c mb-20" style="min-width:auto;box-shadow:none;">
    <div class="fixed-bar">
        <div class="item-title">
            <?php if(!empty(\think\Request::instance()->param('callback_url'))): ?>
            <a class="back_xin" href="javascript:void(0);" onclick="parent.window.location.href = '<?php echo \think\Request::instance()->param('callback_url'); ?>'" title="返回"><i class="iconfont e-fanhui"></i></a>
            <?php else: ?>
    ...
    function showEditor_1597892187(elemtid) {
        ...
        <div class="ncap-form-default">
            <div class="bot2">
                ...
                <?php if(!empty(\think\Request::instance()->param('callback_url'))): ?>
                <a class="ncap-btn-big ncap-btn-no" href="javascript:void(0);" onclick="parent.window.location.href = '<?php echo \think\Request::instance()->param('callback_url'); ?>'" title="返回">返回</a>
                <?php else: ?>
