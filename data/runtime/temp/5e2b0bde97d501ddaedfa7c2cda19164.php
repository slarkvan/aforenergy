<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:35:"./template/pc/lists_guestbook_a.htm";i:1704360524;s:56:"/www/wwwroot/testweb.aforenergy.com/template/pc/head.htm";i:1726294558;s:58:"/www/wwwroot/testweb.aforenergy.com/template/pc/bottom.htm";i:1721290442;}*/ ?>
<!--
 * @Author: ZhouQishun
 * @Date: 2024-01-04 10:45:05
 * @LastEditTime: 2024-01-04 17:23:36
 * @LastEditors: ZhouQishun
 * @Description: 1.0.0
 * @FilePath: \afceshixin.weibaoke.com.cn\template\pc\lists_guestbook_a.htm
 *
-->
<!DOCTYPE html>
<html lang="zh-CN">
...
<style>
  ...
  .inverter-serial-number-label:hover .inverter-serial-number{
    display: block;
  }
...
<div class="he_index">
  ...
  <div class="ys_navph2_header">
    ...
    <div class="he_main">
        ...
        <div class="s_cont1360">
          <div class="he_bordul clearfix">
            <div class="he_bordfr fl">
              <a href="/"> <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/bordi1.svg" alt=""
                  class="he_int1" /> <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/bordi2.svg" alt=""
                  class="he_int2" /> </a>
            </div>
      ...
      <div class="he_k2p1">
        <div class="he_conten1">
          <div class="he_k2p1n row">
            <?php  $typeid = "2"; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $tagGuestbookform = new \think\template\taglib\eyou\TagGuestbookform; $_result = $tagGuestbookform->getGuestbookform($typeid, "auto", "", 1); if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$field): $i= intval($key) + 1;$mod = ($i % 2 ); ?>
            <form class="form-horizontal my-form col-lg-10 col-lg-offset-1" method="POST" <?php echo $field['formhidden']; ?> action="<?php echo $field['action']; ?>"
              onsubmit="<?php echo $field['submit']; ?>">

              <div class="row">
                <div class="form-group col-md-6">
                  <label for="attr_30" class="col-sm-4 control-label">
                    <span class="text-danger">*</span>
                    <span><?php echo $field['itemname_30']; ?></span>
                  </label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="attr_30" name="<?php echo $field['attr_30']; ?>"
                      placeholder="Please enter <?php echo $field['itemname_30']; ?>">
                  </div>
                </div>
                ...
                <div class="form-group col-md-6">
                  <label for="attr_30" class="col-sm-4 control-label">
                    <span class="text-danger">*</span>
                    <span><?php echo $field['itemname_31']; ?></span>
                  </label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="attr_31" name="<?php echo $field['attr_31']; ?>"
                      placeholder="Please enter <?php echo $field['itemname_31']; ?>">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  <label for="attr_32" class="col-sm-4 control-label inverter-serial-number-label">
                    <span class="text-danger">*</span>
                    <span><?php echo $field['itemname_32']; ?></span>
                    <span class="glyphicon glyphicon-question-sign" style="cursor: pointer;" aria-hidden="true"></span>
                    <div class="inverter-serial-number">
                      <img src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/xlh.jpg" alt="">
                    </div>
                  </label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="attr_32" name="<?php echo $field['attr_32']; ?>"
                      placeholder="Please enter <?php echo $field['itemname_32']; ?>">
                  </div>
                </div>

                <div class="form-group col-md-6">
                  <label for="attr_33" class="col-sm-4 control-label">
                    <span class="text-danger">*</span>
                    <span><?php echo $field['itemname_33']; ?></span>
                  </label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="attr_33" name="<?php echo $field['attr_33']; ?>"
                      placeholder="Please enter <?php echo $field['itemname_33']; ?>">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  <label for="attr_34" class="col-sm-4 control-label">
                    <span class="text-danger">*</span>
                    <span><?php echo $field['itemname_34']; ?></span>
                  </label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="attr_34" name="<?php echo $field['attr_34']; ?>"
                      placeholder="Please enter <?php echo $field['itemname_34']; ?>">
                  </div>
                </div>

                <div class="form-group col-md-6">
                  <label for="attr_35" class="col-sm-4 control-label">
                    <span class="text-danger" style="display: none;">*</span>
                    <span><?php echo $field['itemname_35']; ?></span>
                  </label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="attr_35" name="<?php echo $field['attr_35']; ?>"
                      placeholder="Please enter <?php echo $field['itemname_35']; ?>">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  <label for="attr_36" class="col-sm-4 control-label">
                    <span class="text-danger" style="display: none;">*</span>
                    <span><?php echo $field['itemname_36']; ?></span>
                  </label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="attr_36" name="<?php echo $field['attr_36']; ?>"
                      placeholder="Please enter <?php echo $field['itemname_36']; ?>">
                  </div>
                </div>

                <div class="form-group col-md-6">
                  <label for="attr_37" class="col-sm-4 control-label">
                    <span class="text-danger" style="display: none;">*</span>
                    <span><?php echo $field['itemname_37']; ?></span>
                  </label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" id="attr_37" name="<?php echo $field['attr_37']; ?>"
                      placeholder="Please enter <?php echo $field['itemname_37']; ?>">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="form-group col-md-12">
                  <div class="" style="padding: 10px 50px; font-size: 18px;">Fault performance</div>
                </div>
                <div class="form-group col-md-8">
                  <label for="attr_38" class="col-sm-5 control-label">
                    <span class="text-danger">*</span>
                    <span><?php echo $field['itemname_38']; ?></span>
                    <!-- <span class="glyphicon glyphicon-question-sign" style="cursor: pointer;" aria-hidden="true"></span> -->
                  </label>
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="attr_38" name="<?php echo $field['attr_38']; ?>"
                      placeholder="For example：E0/E6/E11">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="form-group col-md-3">
                  <div class="" style="padding: 10px 30px;">LED display</div>
                </div>
                <div class="form-group col-md-9">
                  <div class="row">
                    <label for="attr_39" class="col-sm-3 control-label">
                      <span class="text-danger" style="display: none;">*</span>
                      <span><?php echo $field['itemname_39']; ?></span>
                    </label>

                    <div class="form-group col-sm-9">
                      <?php if(is_array($field['options_39']) || $field['options_39'] instanceof \think\Collection || $field['options_39'] instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $field['options_39'];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$vo): $i= intval($key) + 1;$mod = ($i % 2 ); ?>
                          <div class="col-sm-6" style="display: flex; align-items: center;">
                            <input type="radio" id="attr_39" name="<?php echo $field['attr_39']; ?>" value="<?php echo $vo['value']; ?>" style="appearance: auto; margin-right: 10px;" />
                            <label for="attr_39 control-label">
                              <?php echo $vo['value']; ?>
                            </label>
                          </div>
                  ...
                  <div class="row">
                    <label for="attr_40" class="col-sm-3 control-label">
                      <span class="text-danger" style="display: none;">*</span>
                      <span><?php echo $field['itemname_40']; ?></span>
                    </label>

                    <div class="form-group col-sm-9">
                      <?php if(is_array($field['options_40']) || $field['options_40'] instanceof \think\Collection || $field['options_40'] instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $field['options_40'];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$vo): $i= intval($key) + 1;$mod = ($i % 2 ); ?>
                          <div class="col-sm-6" style="display: flex; align-items: center;">
                            <input type="radio" id="attr_40" name="<?php echo $field['attr_40']; ?>" value="<?php echo $vo['value']; ?>" style="appearance: auto; margin-right: 10px;" />
                            <label for="attr_40 control-label">
                              <?php echo $vo['value']; ?>
                            </label>
                          </div>
                      <?php echo isset($vo["ey_1563185380"])?$vo["ey_1563185380"]:""; ?><?php echo (1 == $e && isset($vo["ey_1563185376"]))?$vo["ey_1563185376"]:""; ++$e; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $vo = []; ?>
                  ...
                  <div class="row">
                    <label for="attr_41" class="col-sm-3 control-label">
                      <span class="text-danger" style="display: none;">*</span>
                      <span><?php echo $field['itemname_41']; ?></span>
                    </label>

                    <div class="form-group col-sm-9">
                      <?php if(is_array($field['options_41']) || $field['options_41'] instanceof \think\Collection || $field['options_41'] instanceof \think\Paginator): $i = 0; $e = 1; $__LIST__ = $field['options_41'];if( count($__LIST__)==0 ) : echo htmlspecialchars_decode("");else: foreach($__LIST__ as $key=>$vo): $i= intval($key) + 1;$mod = ($i % 2 ); ?>
                          <div class="col-sm-6" style="display: flex; align-items: center;">
                            <input type="radio" id="attr_41" name="<?php echo $field['attr_41']; ?>" value="<?php echo $vo['value']; ?>" style="appearance: auto; margin-right: 10px;" />
                            <label for="attr_41 control-label">
                              <?php echo $vo['value']; ?>
                            </label>
                          </div>
                      <?php echo isset($vo["ey_1563185380"])?$vo["ey_1563185380"]:""; ?><?php echo (1 == $e && isset($vo["ey_1563185376"]))?$vo["ey_1563185376"]:""; ++$e; endforeach; endif; else: echo htmlspecialchars_decode("");endif; $vo = []; ?>
              ...
              <div class="row">
                <div class="form-group col-md-10">
                  <label for="attr_42" class="col-sm-3 control-label">
                    <span class="text-danger" style="display: none;">*</span>
                    <span><?php echo $field['itemname_42']; ?></span>
                    <span class="glyphicon glyphicon-question-sign" aria-hidden="true" style="display: none;"></span>
                  </label>
                  <div class="col-sm-9">
                    <textarea type="text" class="form-control" id="attr_42" name="<?php echo $field['attr_42']; ?>"
                      placeholder="For example, after the inverter countdown is completed, the display shows that the grid voltage is abnormal and the inverter FAULT light is on."></textarea>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="form-group col-md-12">
                  ...
                  <div class="col-sm-9" style="display: flex; align-items: center;">
                    <div class="col-sm-6">
                      <input <?php echo $field['realValidate']['verifyInput']; ?> class="form-control" id="attr_38" name="<?php echo $field['attr_38']; ?>"
                      placeholder="Please enter Image verification code">
                    </div>
                    <div class="col-sm-3">
                      <img <?php echo $field['realValidate']['verifyImg']; ?> title="Can't see? Click to replace the verification code" style="height: 50px;" class=""/>
                    </div>
                    <div class="col-sm-2">
                      <a <?php echo $field['realValidate']['verifyClick']; ?> class="">Click to replace</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="row" style="margin-top: 20px;">
                <div class="form-group col-md-12">
                  <label for="attr_42" class="col-sm-12">
                    <span class="text-danger">*</span>
                    <span>is a required option, please rest assured that any of your personal information will not be leaked, only the company is available. After-sales service call: +86-21-54326236</span>
                    <span class="glyphicon glyphicon-question-sign" aria-hidden="true" style="display: none;"></span>
                  </label>
                </div>
              </div>

              <div class="eyou_form_attr row" style="margin-top: 30px;">
                <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                  <button class="eyou_form_btn btn btn-danger btn-lg btn-block" type="submit">submit</button>
                </div>
              </div>
