<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:33:"./template/pc/lists_article_c.htm";i:1726285148;s:56:"/www/wwwroot/testweb.aforenergy.com/template/pc/head.htm";i:1726294558;s:58:"/www/wwwroot/testweb.aforenergy.com/template/pc/bottom.htm";i:1721290442;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
  <head>
    <meta charset="utf-8" />
        ...
        <div class="he_bordkm">
          <div class="s_cont1360">
            <div class="he_bordul clearfix">
              ...
              <div class="he_bordli fl">&gt;  <?php  $typeid = ""; if(empty($typeid) && isset($channelartlist["id"]) && !empty($channelartlist["id"])) : $typeid = intval($channelartlist["id"]); endif;  $tagPosition = new \think\template\taglib\eyou\TagPosition; $__VALUE__ = $tagPosition->getPosition($typeid, "", " "); echo $__VALUE__; ?></div>
            </div>
          </div>
        </div>
        ...
        <div class="s_b2cont s_cont1514">
          <div class="he_quline">
            <div class="s_qhbox">
              ...
              <div
                class="s_qhnr <?php echo $eyou['field']['id']==$field1['id']?'act' : ''; ?>"
                data-id="<?php echo $field1['id']; ?>"
                data-type="one"
              >
                <a href="<?php echo $field1['typeurl']; ?>"><?php echo $field1['typename']; ?></a>
              </div>
            ...
            <div class="s_b2_3c2list fl wow g_fadeup1">
              <a href="<?php echo $field['arcurl']; ?>">
                <div class="s_b2_3c2li">
                  ...
                  <div class="s_b2c3ig">
                    <img
                      src="<?php  $tagGlobal = new \think\template\taglib\eyou\TagGlobal; $__VALUE__ = $tagGlobal->getGlobal("web_templets_pc"); echo $__VALUE__; ?>/skin/img/b2_img00.png"
                      alt=""
                      class="s_b2c3ig1"
                    />
                  ...
                  <p><?php echo $field['title']; ?></p>
                  <p><?php  $aid = $field['aid']; $tagField = new \think\template\taglib\eyou\TagField; $__VALUE__ = $tagField->getField("selticof", $aid); echo $__VALUE__; unset($aid); ?></p>
                  <p><?php  $aid = $field['aid']; $tagField = new \think\template\taglib\eyou\TagField; $__VALUE__ = $tagField->getField("Battery1", $aid); echo $__VALUE__; unset($aid); ?></p>
                  <div class="s_b2_3c2libot clearfix" style="padding-top: 15px;">
                    <div class="s_b2_3libotl fl p16">MORE</div>
    ...
    <script>
      ...
      $(function () {
        ...
        $('.s_b2c2xlbotnr').click(function () {
          ...
          $(this).parents('.s_b2c2xl').find('.s_b2c2xltop').find('.s_select_show2').val(selectShow);
          $(this)
            .parents('.s_b2c2xl')
            .find('.s_b2c2xltop')
            .find('.s_select_real2')
