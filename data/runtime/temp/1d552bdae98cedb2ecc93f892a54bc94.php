<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:56:"./application/admin/template/archives/index_archives.htm";i:1692667952;s:80:"/www/wwwroot/testweb.aforenergy.com/application/admin/template/public/layout.htm";i:1692667952;s:83:"/www/wwwroot/testweb.aforenergy.com/application/admin/template/public/theme_css.htm";i:1680508822;s:84:"/www/wwwroot/testweb.aforenergy.com/application/admin/template/archives/tags_btn.htm";i:1692667952;s:84:"/www/wwwroot/testweb.aforenergy.com/application/admin/template/archives/flag_btn.htm";i:1680508822;s:78:"/www/wwwroot/testweb.aforenergy.com/application/admin/template/public/page.htm";i:1655708910;s:80:"/www/wwwroot/testweb.aforenergy.com/application/admin/template/public/footer.htm";i:1680508822;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page min-hg-c-66">
    ...
    <?php if(is_check_access(CONTROLLER_NAME.'@add') == '1'): ?>
        <div class="fbutton" style="float: none;">
            <input type="hidden" id="releaseUrl" value="<?php echo url(CONTROLLER_NAME.'/add', ['channel'=>\think\Request::instance()->param('channel'), 'typeid'=>\think\Request::instance()->param('typeid')], true, $website_host); ?>">
            <a href="<?php if(\think\Request::instance()->param('typeid') > '0'): ?>javascript:archivesRelease('<?php echo CONTROLLER_NAME; ?>', <?php echo (isset($shopOpen) && ($shopOpen !== '')?$shopOpen:'0'); ?>, '', <?php echo \think\Request::instance()->param('typeid'); ?>);<?php else: ?>javascript:quick_release(<?php echo (isset($is_arctype) && ($is_arctype !== '')?$is_arctype:'1'); ?>);<?php endif; ?>">
                <div class="add">
    ...
    <script type="text/javascript">
        ...
        function productEdit(obj, shopOpen) {
            // 提示是否前往商城中心
            var releaseUrl = $(obj).attr('data-url');
            if (1 === parseInt(shopOpen)) {
                confirmRelease(releaseUrl, 'edit');
                return false;
            }
        ...
        function confirmRelease(url, opt) {
            var btn1 = '前往商城中心';
                                ...
                                <div class="tl pdl10" >
                                    ...
                                    <?php endif; if(is_check_access('Archives@edit') == '1'): if(empty($channelRow[$vo['channel']]['ifsystem'])): ?>
                                        ...
                                        <?php elseif('Product' == $channelRow[$vo['channel']]['ctl_name']): ?>
                                            <a href="JavaScript:void(0);" data-url="<?php echo url('Product/edit', ['id'=>$vo['aid'], 'typeid'=>\think\Request::instance()->param('typeid')]); ?>" onclick="productEdit(this, <?php echo (isset($shopOpen) && ($shopOpen !== '')?$shopOpen:'0'); ?>);" style="<?php if($vo['is_b'] == '1'): ?> font-weight: bold; <?php endif; ?>"><?php echo $vo['title']; ?></a>
                                        <?php else: ?>
                            ...
                            <td class="operation">
                                <div class="w160 tc">
                                    <?php if(is_check_access('Archives@edit') == '1'): if(empty($channelRow[$vo['channel']]['ifsystem'])): ?>
                                        ...
                                        <?php elseif('Product' == $channelRow[$vo['channel']]['ctl_name']): ?>
                                        <a href="JavaScript:void(0);" data-url="<?php echo url('Product/edit', ['id'=>$vo['aid'], 'typeid'=>\think\Request::instance()->param('typeid')]); ?>" onclick="productEdit(this, <?php echo (isset($shopOpen) && ($shopOpen !== '')?$shopOpen:'0'); ?>);" class="btn blue">编辑</a>
                                        <?php else: ?>
