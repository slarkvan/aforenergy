<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"./application/admin/template/uploadimgnew/get_upload_list.htm";i:1711606141;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <script type="text/javascript">
            ...
            var upload_num = <?php echo (isset($info['num']) && ($info['num'] !== '')?$info['num']:1); ?>;
        ...
        <script type="text/javascript" src="/public/plugins/uploadimgnew/js/get_upload_list.js?v=<?php echo $version; ?>1"></script>
    </body>
</html>
